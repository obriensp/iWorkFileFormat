...
#ifndef PROTOBUF_TSCHPreUFFArchives_2eproto__INCLUDED
#define PROTOBUF_TSCHPreUFFArchives_2eproto__INCLUDED
...
class ChartInfoArchive : public ::google::protobuf::Message {
 public:
  ChartInfoArchive();
  virtual ~ChartInfoArchive();
  ...
  void Swap(ChartInfoArchive* other);

  // implements Message ----------------------------------------------

  ChartInfoArchive* New() const;
  ...
  inline bool has_chart_model() const;
  inline void clear_chart_model();
  static const int kChartModelFieldNumber = 2;
  inline const ::TSCH::PreUFF::ChartModelArchive& chart_model() const;
  inline ::TSCH::PreUFF::ChartModelArchive* mutable_chart_model();
  inline ::TSCH::PreUFF::ChartModelArchive* release_chart_model();
  inline void set_allocated_chart_model(::TSCH::PreUFF::ChartModelArchive* chart_model);
  ...
  static const int kChartTypeFieldNumber = 4;
  ...
  inline bool has_legend_model() const;
  inline void clear_legend_model();
  static const int kLegendModelFieldNumber = 5;
  inline const ::TSCH::PreUFF::LegendModelArchive& legend_model() const;
  inline ::TSCH::PreUFF::LegendModelArchive* mutable_legend_model();
  inline ::TSCH::PreUFF::LegendModelArchive* release_legend_model();
  inline void set_allocated_legend_model(::TSCH::PreUFF::LegendModelArchive* legend_model);

  // required .TSCH.RectArchive inner_chart_frame = 6;
  inline bool has_inner_chart_frame() const;
  inline void clear_inner_chart_frame();
  static const int kInnerChartFrameFieldNumber = 6;
  inline const ::TSCH::RectArchive& inner_chart_frame() const;
  inline ::TSCH::RectArchive* mutable_inner_chart_frame();
  inline ::TSCH::RectArchive* release_inner_chart_frame();
  inline void set_allocated_inner_chart_frame(::TSCH::RectArchive* inner_chart_frame);

  // repeated .TSP.Reference value_axis_styles = 7;
  inline int value_axis_styles_size() const;
  inline void clear_value_axis_styles();
  static const int kValueAxisStylesFieldNumber = 7;
  ...
  static const int kCategoryAxisStylesFieldNumber = 8;
  ...
  static const int kValueAxisNonstylesFieldNumber = 9;
  ...
  static const int kCategoryAxisNonstylesFieldNumber = 10;
  ...
  static const int kSeriesThemeStylesFieldNumber = 11;
  ...
  static const int kSeriesPrivateStylesFieldNumber = 12;
  ...
  static const int kSeriesNonStylesFieldNumber = 13;
  ...
  inline bool has_non_style() const;
  inline void clear_non_style();
  static const int kNonStyleFieldNumber = 14;
  inline const ::TSP::Reference& non_style() const;
  inline ::TSP::Reference* mutable_non_style();
  inline ::TSP::Reference* release_non_style();
  inline void set_allocated_non_style(::TSP::Reference* non_style);

  // optional .TSP.Reference mediator = 15;
  inline bool has_mediator() const;
  inline void clear_mediator();
  static const int kMediatorFieldNumber = 15;
  ...
  inline bool has_cde_preview_origin() const;
  inline void clear_cde_preview_origin();
  static const int kCdePreviewOriginFieldNumber = 16;
  inline const ::TSP::Point& cde_preview_origin() const;
  inline ::TSP::Point* mutable_cde_preview_origin();
  inline ::TSP::Point* release_cde_preview_origin();
  inline void set_allocated_cde_preview_origin(::TSP::Point* cde_preview_origin);

  // optional .TSP.Reference chart_style_preset = 17;
  inline bool has_chart_style_preset() const;
  inline void clear_chart_style_preset();
  static const int kChartStylePresetFieldNumber = 17;
  inline const ::TSP::Reference& chart_style_preset() const;
  inline ::TSP::Reference* mutable_chart_style_preset();
  inline ::TSP::Reference* release_chart_style_preset();
  inline void set_allocated_chart_style_preset(::TSP::Reference* chart_style_preset);

  // repeated .TSP.Reference paragraph_styles = 18;
  inline int paragraph_styles_size() const;
  inline void clear_paragraph_styles();
  static const int kParagraphStylesFieldNumber = 18;
  ...
  inline bool has_last_row_sected_in_the_cde() const;
  inline void clear_last_row_sected_in_the_cde();
  static const int kLastRowSectedInTheCdeFieldNumber = 19;
  inline ::google::protobuf::int32 last_row_sected_in_the_cde() const;
  inline void set_last_row_sected_in_the_cde(::google::protobuf::int32 value);

  // optional int32 last_column_sected_in_the_cde = 20;
  inline bool has_last_column_sected_in_the_cde() const;
  inline void clear_last_column_sected_in_the_cde();
  static const int kLastColumnSectedInTheCdeFieldNumber = 20;
  inline ::google::protobuf::int32 last_column_sected_in_the_cde() const;
  inline void set_last_column_sected_in_the_cde(::google::protobuf::int32 value);

  // optional int32 chart_style_preset_index = 21;
  inline bool has_chart_style_preset_index() const;
  inline void clear_chart_style_preset_index();
  static const int kChartStylePresetIndexFieldNumber = 21;
  inline ::google::protobuf::int32 chart_style_preset_index() const;
  inline void set_chart_style_preset_index(::google::protobuf::int32 value);
 ...
 private:
  ...
  inline void set_has_chart_model();
  inline void clear_has_chart_model();
  inline void set_has_style();
  inline void clear_has_style();
  inline void set_has_chart_type();
  inline void clear_has_chart_type();
  inline void set_has_legend_model();
  inline void clear_has_legend_model();
  inline void set_has_inner_chart_frame();
  inline void clear_has_inner_chart_frame();
  ...
  inline void set_has_non_style();
  inline void clear_has_non_style();
  inline void set_has_mediator();
  inline void clear_has_mediator();
  inline void set_has_cde_preview_origin();
  inline void clear_has_cde_preview_origin();
  inline void set_has_chart_style_preset();
  inline void clear_has_chart_style_preset();
  inline void set_has_last_row_sected_in_the_cde();
  inline void clear_has_last_row_sected_in_the_cde();
  inline void set_has_last_column_sected_in_the_cde();
  inline void clear_has_last_column_sected_in_the_cde();
  inline void set_has_chart_style_preset_index();
  inline void clear_has_chart_style_preset_index();
  ...
  int chart_type_;
  ::google::protobuf::int32 last_row_sected_in_the_cde_;
  ...
  ::google::protobuf::int32 last_column_sected_in_the_cde_;
  ::google::protobuf::int32 chart_style_preset_index_;
  bool needs_calc_engine_deferred_import_action_;

  mutable int _cached_size_;
  ::google::protobuf::uint32 _has_bits_[(22 + 31) / 32];

  friend void  protobuf_AddDesc_TSCHPreUFFArchives_2eproto();
  friend void protobuf_AssignDesc_TSCHPreUFFArchives_2eproto();
  friend void protobuf_ShutdownFile_TSCHPreUFFArchives_2eproto();

  void InitAsDefaultInstance();
  static ChartInfoArchive* default_instance_;
};
// -------------------------------------------------------------------

class LegendModelArchive : public ::google::protobuf::Message {
 public:
  LegendModelArchive();
  virtual ~LegendModelArchive();
  ...
  void Swap(LegendModelArchive* other);

  // implements Message ----------------------------------------------

  LegendModelArchive* New() const;
  void CopyFrom(const ::google::protobuf::Message& from);
  void MergeFrom(const ::google::protobuf::Message& from);
  ...
  inline const ::TSCH::RectArchive& frame() const;
  inline ::TSCH::RectArchive* mutable_frame();
  inline ::TSCH::RectArchive* release_frame();
  inline void set_allocated_frame(::TSCH::RectArchive* frame);
  ...
  inline bool has_non_style() const;
  inline void clear_non_style();
  static const int kNonStyleFieldNumber = 4;
  inline const ::TSP::Reference& non_style() const;
  inline ::TSP::Reference* mutable_non_style();
  inline ::TSP::Reference* release_non_style();
  inline void set_allocated_non_style(::TSP::Reference* non_style);
 ...
 private:
  ...
  void InitAsDefaultInstance();
  static LegendModelArchive* default_instance_;
};
// -------------------------------------------------------------------

class ChartModelArchive : public ::google::protobuf::Message {
 public:
  ChartModelArchive();
  virtual ~ChartModelArchive();
  ...
  void Swap(ChartModelArchive* other);

  // implements Message ----------------------------------------------

  ChartModelArchive* New() const;
  void CopyFrom(const ::google::protobuf::Message& from);
  void MergeFrom(const ::google::protobuf::Message& from);
  ...
  inline const ::TSP::Reference& grid() const;
  inline ::TSP::Reference* mutable_grid();
  inline ::TSP::Reference* release_grid();
  inline void set_allocated_grid(::TSP::Reference* grid);

  // repeated uint32 series_types = 3;
  inline int series_types_size() const;
  inline void clear_series_types();
  static const int kSeriesTypesFieldNumber = 3;
  inline ::google::protobuf::uint32 series_types(int index) const;
  inline void set_series_types(int index, ::google::protobuf::uint32 value);
  inline void add_series_types(::google::protobuf::uint32 value);
  ...
  static const int kScatterFormatFieldNumber = 4;
  inline ::google::protobuf::uint32 scatter_format() const;
  inline void set_scatter_format(::google::protobuf::uint32 value);

  // optional .TSCH.PreUFF.ChartGridArchive inline_grid = 5;
  inline bool has_inline_grid() const;
  inline void clear_inline_grid();
  static const int kInlineGridFieldNumber = 5;
  inline const ::TSCH::PreUFF::ChartGridArchive& inline_grid() const;
  inline ::TSCH::PreUFF::ChartGridArchive* mutable_inline_grid();
  inline ::TSCH::PreUFF::ChartGridArchive* release_inline_grid();
  inline void set_allocated_inline_grid(::TSCH::PreUFF::ChartGridArchive* inline_grid);

  // optional uint32 multidataset_index = 6;
  inline bool has_multidataset_index() const;
  inline void clear_multidataset_index();
  static const int kMultidatasetIndexFieldNumber = 6;
 ...
 private:
  ...
  inline void set_has_inline_grid();
  inline void clear_has_inline_grid();
  ...
  ::TSP::Reference* info_;
  ::TSP::Reference* grid_;
  ::google::protobuf::RepeatedField< ::google::protobuf::uint32 > series_types_;
  ::TSCH::PreUFF::ChartGridArchive* inline_grid_;
  ::google::protobuf::uint32 scatter_format_;
  ...
  void InitAsDefaultInstance();
  static ChartModelArchive* default_instance_;
};
// -------------------------------------------------------------------

class ChartGridArchive_ValueRow : public ::google::protobuf::Message {
 public:
  ChartGridArchive_ValueRow();
  virtual ~ChartGridArchive_ValueRow();
  ...
  void Swap(ChartGridArchive_ValueRow* other);

  // implements Message ----------------------------------------------

  ChartGridArchive_ValueRow* New() const;
  void CopyFrom(const ::google::protobuf::Message& from);
  void MergeFrom(const ::google::protobuf::Message& from);
 ...
 private:
  ...
  void InitAsDefaultInstance();
  static ChartGridArchive_ValueRow* default_instance_;
};
// -------------------------------------------------------------------
...
class ChartGridArchive : public ::google::protobuf::Message {
 public:
  ...
  static const int kRowNameFieldNumber = 2;
  ...
  static const int kValueRowFieldNumber = 4;
  inline const ::TSCH::PreUFF::ChartGridArchive_ValueRow& value_row(int index) const;
  inline ::TSCH::PreUFF::ChartGridArchive_ValueRow* mutable_value_row(int index);
  inline ::TSCH::PreUFF::ChartGridArchive_ValueRow* add_value_row();
  inline const ::google::protobuf::RepeatedPtrField< ::TSCH::PreUFF::ChartGridArchive_ValueRow >&
      value_row() const;
  inline ::google::protobuf::RepeatedPtrField< ::TSCH::PreUFF::ChartGridArchive_ValueRow >*
      mutable_value_row();
 ...
 private:
  ...
  bool dirty_;
  ::google::protobuf::RepeatedPtrField< ::TSCH::PreUFF::ChartGridArchive_ValueRow > value_row_;
...
class ChartsNumberFormatArchive : public ::google::protobuf::Message {
 public:
  ChartsNumberFormatArchive();
  virtual ~ChartsNumberFormatArchive();
  ...
  void Swap(ChartsNumberFormatArchive* other);

  // implements Message ----------------------------------------------

  ChartsNumberFormatArchive* New() const;
  void CopyFrom(const ::google::protobuf::Message& from);
  void MergeFrom(const ::google::protobuf::Message& from);
  ...
  inline ::TSCH::NumberValueType value_type() const;
  inline void set_value_type(::TSCH::NumberValueType value);

  // optional string format_string = 2;
  inline bool has_format_string() const;
  inline void clear_format_string();
  static const int kFormatStringFieldNumber = 2;
  inline const ::std::string& format_string() const;
  inline void set_format_string(const ::std::string& value);
  inline void set_format_string(const char* value);
  inline void set_format_string(const char* value, size_t size);
  inline ::std::string* mutable_format_string();
  inline ::std::string* release_format_string();
  inline void set_allocated_format_string(::std::string* format_string);
  ...
  static const int kCurrencyCodeFieldNumber = 4;
  ...
  static const int kNegativeStyleFieldNumber = 5;
  inline ::TSCH::NegativeNumberStyle negative_style() const;
  inline void set_negative_style(::TSCH::NegativeNumberStyle value);
  ...
  static const int kShowThousandsSeparatorFieldNumber = 6;
  ...
  static const int kFractionAccuracyFieldNumber = 7;
  inline ::TSCH::FractionAccuracy fraction_accuracy() const;
  inline void set_fraction_accuracy(::TSCH::FractionAccuracy value);

  // optional string suffix_string = 8;
  inline bool has_suffix_string() const;
  inline void clear_suffix_string();
  static const int kSuffixStringFieldNumber = 8;
  inline const ::std::string& suffix_string() const;
  inline void set_suffix_string(const ::std::string& value);
  inline void set_suffix_string(const char* value);
  inline void set_suffix_string(const char* value, size_t size);
  inline ::std::string* mutable_suffix_string();
  inline ::std::string* release_suffix_string();
  inline void set_allocated_suffix_string(::std::string* suffix_string);

  // required uint32 base = 9;
  inline bool has_base() const;
  inline void clear_base();
  static const int kBaseFieldNumber = 9;
  ...
  static const int kBasePlacesFieldNumber = 10;
  ...
  static const int kBaseUseMinusSignFieldNumber = 11;
  ...
  static const int kUseAccountingStyleFieldNumber = 12;
  ...
  static const int kIsCustomFieldNumber = 13;
  ...
  static const int kScaleFactorFieldNumber = 14;
  ...
  static const int kInterstitialStringsFieldNumber = 15;
  ...
  inline bool has_interstitial_string_insertion_indexes() const;
  inline void clear_interstitial_string_insertion_indexes();
  static const int kInterstitialStringInsertionIndexesFieldNumber = 16;
  inline const ::TSP::IndexSet& interstitial_string_insertion_indexes() const;
  inline ::TSP::IndexSet* mutable_interstitial_string_insertion_indexes();
  inline ::TSP::IndexSet* release_interstitial_string_insertion_indexes();
  inline void set_allocated_interstitial_string_insertion_indexes(::TSP::IndexSet* interstitial_string_insertion_indexes);

  // required uint32 index_from_right_of_last_digit_placeholder = 17;
  inline bool has_index_from_right_of_last_digit_placeholder() const;
  inline void clear_index_from_right_of_last_digit_placeholder();
  static const int kIndexFromRightOfLastDigitPlaceholderFieldNumber = 17;
  inline ::google::protobuf::uint32 index_from_right_of_last_digit_placeholder() const;
  inline void set_index_from_right_of_last_digit_placeholder(::google::protobuf::uint32 value);

  // required bool is_text_format = 18;
  inline bool has_is_text_format() const;
  inline void clear_is_text_format();
  static const int kIsTextFormatFieldNumber = 18;
  inline bool is_text_format() const;
  inline void set_is_text_format(bool value);

  // required uint32 minimum_integer_width = 19;
  inline bool has_minimum_integer_width() const;
  inline void clear_minimum_integer_width();
  static const int kMinimumIntegerWidthFieldNumber = 19;
  inline ::google::protobuf::uint32 minimum_integer_width() const;
  inline void set_minimum_integer_width(::google::protobuf::uint32 value);

  // required uint32 decimal_width = 20;
  inline bool has_decimal_width() const;
  inline void clear_decimal_width();
  static const int kDecimalWidthFieldNumber = 20;
  ...
  inline bool has_number_of_non_space_integer_placeholder_digits() const;
  inline void clear_number_of_non_space_integer_placeholder_digits();
  static const int kNumberOfNonSpaceIntegerPlaceholderDigitsFieldNumber = 21;
  inline ::google::protobuf::uint32 number_of_non_space_integer_placeholder_digits() const;
  inline void set_number_of_non_space_integer_placeholder_digits(::google::protobuf::uint32 value);

  // required uint32 number_of_non_space_decimal_placeholder_digits = 22;
  inline bool has_number_of_non_space_decimal_placeholder_digits() const;
  inline void clear_number_of_non_space_decimal_placeholder_digits();
  static const int kNumberOfNonSpaceDecimalPlaceholderDigitsFieldNumber = 22;
  inline ::google::protobuf::uint32 number_of_non_space_decimal_placeholder_digits() const;
  inline void set_number_of_non_space_decimal_placeholder_digits(::google::protobuf::uint32 value);

  // optional string format_name = 23;
  inline bool has_format_name() const;
  inline void clear_format_name();
  static const int kFormatNameFieldNumber = 23;
  inline const ::std::string& format_name() const;
  inline void set_format_name(const ::std::string& value);
  inline void set_format_name(const char* value);
  inline void set_format_name(const char* value, size_t size);
  inline ::std::string* mutable_format_name();
  inline ::std::string* release_format_name();
  inline void set_allocated_format_name(::std::string* format_name);

  // optional string prefix_string = 24;
  inline bool has_prefix_string() const;
  inline void clear_prefix_string();
  static const int kPrefixStringFieldNumber = 24;
  inline const ::std::string& prefix_string() const;
  inline void set_prefix_string(const ::std::string& value);
  inline void set_prefix_string(const char* value);
  inline void set_prefix_string(const char* value, size_t size);
  inline ::std::string* mutable_prefix_string();
  inline ::std::string* release_prefix_string();
  inline void set_allocated_prefix_string(::std::string* prefix_string);
 ...
 private:
  ...
  inline void set_has_format_string();
  inline void clear_has_format_string();
  ...
  inline void set_has_suffix_string();
  inline void clear_has_suffix_string();
  ...
  inline void set_has_interstitial_string_insertion_indexes();
  inline void clear_has_interstitial_string_insertion_indexes();
  inline void set_has_index_from_right_of_last_digit_placeholder();
  inline void clear_has_index_from_right_of_last_digit_placeholder();
  inline void set_has_is_text_format();
  inline void clear_has_is_text_format();
  inline void set_has_minimum_integer_width();
  inline void clear_has_minimum_integer_width();
  inline void set_has_decimal_width();
  inline void clear_has_decimal_width();
  inline void set_has_number_of_non_space_integer_placeholder_digits();
  inline void clear_has_number_of_non_space_integer_placeholder_digits();
  inline void set_has_number_of_non_space_decimal_placeholder_digits();
  inline void clear_has_number_of_non_space_decimal_placeholder_digits();
  inline void set_has_format_name();
  inline void clear_has_format_name();
  inline void set_has_prefix_string();
  inline void clear_has_prefix_string();
  ...
  bool is_custom_;
  ::google::protobuf::uint32 index_from_right_of_last_digit_placeholder_;
  ...
  ::google::protobuf::uint32 minimum_integer_width_;
  ::google::protobuf::uint32 decimal_width_;
  ::google::protobuf::uint32 number_of_non_space_integer_placeholder_digits_;
  ::std::string* format_name_;
  ::std::string* prefix_string_;
  ::google::protobuf::uint32 number_of_non_space_decimal_placeholder_digits_;
  ...
  void InitAsDefaultInstance();
  static ChartsNumberFormatArchive* default_instance_;
};
// -------------------------------------------------------------------
...
class ChartStyleArchive : public ::google::protobuf::Message {
 public:
  ...
  static const int kTschchartinfodefaultbackgroundfillFieldNumber = 10;
  ...
  static const int kTschchartinfodefaultbackgroundstrokeFieldNumber = 11;
  ...
  static const int kTschchartinfodefaultgridbackgroundfillFieldNumber = 12;
  ...
  static const int kTschchartinfodefaultintersetgapFieldNumber = 13;
  ...
  static const int kTschchartinfodefaultinterbargapFieldNumber = 14;
  ...
  static const int kTschchartinfodefaultshowborderFieldNumber = 15;
  ...
  static const int kTschchartinfodefaultborderstrokeFieldNumber = 16;
  ...
  static const int kTschchartinfodefaulttitlecolorFieldNumber = 18;
  ...
  static const int kTschchartinfodefaultgridbackgroundopacityFieldNumber = 19;
  ...
  static const int kTschchartinfodefaultcombinelayersFieldNumber = 20;
  ...
  static const int kTschchartinfodefaultbordershadowFieldNumber = 21;
  ...
  static const int kTschchartinfodefaultborderopacityFieldNumber = 22;
  ...
  static const int kTschchartinfodefaulttitleparagraphstyleindexFieldNumber = 23;
  ...
  inline bool has_tschchartinfodefaultdeprecatedmasterfontfamily() const;
  inline void clear_tschchartinfodefaultdeprecatedmasterfontfamily();
  static const int kTschchartinfodefaultdeprecatedmasterfontfamilyFieldNumber = 24;
  inline const ::std::string& tschchartinfodefaultdeprecatedmasterfontfamily() const;
  inline void set_tschchartinfodefaultdeprecatedmasterfontfamily(const ::std::string& value);
  inline void set_tschchartinfodefaultdeprecatedmasterfontfamily(const char* value);
  inline void set_tschchartinfodefaultdeprecatedmasterfontfamily(const char* value, size_t size);
  inline ::std::string* mutable_tschchartinfodefaultdeprecatedmasterfontfamily();
  inline ::std::string* release_tschchartinfodefaultdeprecatedmasterfontfamily();
  inline void set_allocated_tschchartinfodefaultdeprecatedmasterfontfamily(::std::string* tschchartinfodefaultdeprecatedmasterfontfamily);

  // optional int32 tschchartinfodefaultdeprecatedmasterfontnamedsize = 25;
  inline bool has_tschchartinfodefaultdeprecatedmasterfontnamedsize() const;
  inline void clear_tschchartinfodefaultdeprecatedmasterfontnamedsize();
  static const int kTschchartinfodefaultdeprecatedmasterfontnamedsizeFieldNumber = 25;
  inline ::google::protobuf::int32 tschchartinfodefaultdeprecatedmasterfontnamedsize() const;
  inline void set_tschchartinfodefaultdeprecatedmasterfontnamedsize(::google::protobuf::int32 value);

  // optional int32 tschchartinfodefaultdeprecatedtrendlineequationparagraphstyleindex = 30;
  inline bool has_tschchartinfodefaultdeprecatedtrendlineequationparagraphstyleindex() const;
  inline void clear_tschchartinfodefaultdeprecatedtrendlineequationparagraphstyleindex();
  static const int kTschchartinfodefaultdeprecatedtrendlineequationparagraphstyleindexFieldNumber = 30;
  inline ::google::protobuf::int32 tschchartinfodefaultdeprecatedtrendlineequationparagraphstyleindex() const;
  inline void set_tschchartinfodefaultdeprecatedtrendlineequationparagraphstyleindex(::google::protobuf::int32 value);

  // optional int32 tschchartinfodefaultdeprecatedtrendlinersquaredparagraphstyleindex = 31;
  inline bool has_tschchartinfodefaultdeprecatedtrendlinersquaredparagraphstyleindex() const;
  inline void clear_tschchartinfodefaultdeprecatedtrendlinersquaredparagraphstyleindex();
  static const int kTschchartinfodefaultdeprecatedtrendlinersquaredparagraphstyleindexFieldNumber = 31;
  inline ::google::protobuf::int32 tschchartinfodefaultdeprecatedtrendlinersquaredparagraphstyleindex() const;
  inline void set_tschchartinfodefaultdeprecatedtrendlinersquaredparagraphstyleindex(::google::protobuf::int32 value);

  // optional .TSD.ShadowArchive tschchartinfodefaultdeprecatedtrendlineequationshadow = 32;
  inline bool has_tschchartinfodefaultdeprecatedtrendlineequationshadow() const;
  inline void clear_tschchartinfodefaultdeprecatedtrendlineequationshadow();
  static const int kTschchartinfodefaultdeprecatedtrendlineequationshadowFieldNumber = 32;
  inline const ::TSD::ShadowArchive& tschchartinfodefaultdeprecatedtrendlineequationshadow() const;
  inline ::TSD::ShadowArchive* mutable_tschchartinfodefaultdeprecatedtrendlineequationshadow();
  inline ::TSD::ShadowArchive* release_tschchartinfodefaultdeprecatedtrendlineequationshadow();
  inline void set_allocated_tschchartinfodefaultdeprecatedtrendlineequationshadow(::TSD::ShadowArchive* tschchartinfodefaultdeprecatedtrendlineequationshadow);

  // optional .TSD.ShadowArchive tschchartinfodefaultdeprecatedtrendlinersquaredshadow = 33;
  inline bool has_tschchartinfodefaultdeprecatedtrendlinersquaredshadow() const;
  inline void clear_tschchartinfodefaultdeprecatedtrendlinersquaredshadow();
  static const int kTschchartinfodefaultdeprecatedtrendlinersquaredshadowFieldNumber = 33;
  inline const ::TSD::ShadowArchive& tschchartinfodefaultdeprecatedtrendlinersquaredshadow() const;
  inline ::TSD::ShadowArchive* mutable_tschchartinfodefaultdeprecatedtrendlinersquaredshadow();
  inline ::TSD::ShadowArchive* release_tschchartinfodefaultdeprecatedtrendlinersquaredshadow();
  inline void set_allocated_tschchartinfodefaultdeprecatedtrendlinersquaredshadow(::TSD::ShadowArchive* tschchartinfodefaultdeprecatedtrendlinersquaredshadow);

  // optional float tschchartinfodefaultdeprecatedtrendlineequationopacity = 34;
  inline bool has_tschchartinfodefaultdeprecatedtrendlineequationopacity() const;
  inline void clear_tschchartinfodefaultdeprecatedtrendlineequationopacity();
  static const int kTschchartinfodefaultdeprecatedtrendlineequationopacityFieldNumber = 34;
  inline float tschchartinfodefaultdeprecatedtrendlineequationopacity() const;
  inline void set_tschchartinfodefaultdeprecatedtrendlineequationopacity(float value);

  // optional float tschchartinfodefaultdeprecatedtrendlinersquaredopacity = 35;
  inline bool has_tschchartinfodefaultdeprecatedtrendlinersquaredopacity() const;
  inline void clear_tschchartinfodefaultdeprecatedtrendlinersquaredopacity();
  static const int kTschchartinfodefaultdeprecatedtrendlinersquaredopacityFieldNumber = 35;
  inline float tschchartinfodefaultdeprecatedtrendlinersquaredopacity() const;
  inline void set_tschchartinfodefaultdeprecatedtrendlinersquaredopacity(float value);

  // optional .TSD.ShadowArchive tschchartinfobardeprecated3dshadow = 308;
  inline bool has_tschchartinfobardeprecated3dshadow() const;
  inline void clear_tschchartinfobardeprecated3dshadow();
  static const int kTschchartinfobardeprecated3DshadowFieldNumber = 308;
  inline const ::TSD::ShadowArchive& tschchartinfobardeprecated3dshadow() const;
  inline ::TSD::ShadowArchive* mutable_tschchartinfobardeprecated3dshadow();
  inline ::TSD::ShadowArchive* release_tschchartinfobardeprecated3dshadow();
  inline void set_allocated_tschchartinfobardeprecated3dshadow(::TSD::ShadowArchive* tschchartinfobardeprecated3dshadow);

  // optional .TSD.ShadowArchive tschchartinfocolumndeprecated3dshadow = 309;
  inline bool has_tschchartinfocolumndeprecated3dshadow() const;
  inline void clear_tschchartinfocolumndeprecated3dshadow();
  static const int kTschchartinfocolumndeprecated3DshadowFieldNumber = 309;
  inline const ::TSD::ShadowArchive& tschchartinfocolumndeprecated3dshadow() const;
  inline ::TSD::ShadowArchive* mutable_tschchartinfocolumndeprecated3dshadow();
  inline ::TSD::ShadowArchive* release_tschchartinfocolumndeprecated3dshadow();
  inline void set_allocated_tschchartinfocolumndeprecated3dshadow(::TSD::ShadowArchive* tschchartinfocolumndeprecated3dshadow);

  // optional .TSD.ShadowArchive tschchartinfolinedeprecated3dshadow = 310;
  inline bool has_tschchartinfolinedeprecated3dshadow() const;
  inline void clear_tschchartinfolinedeprecated3dshadow();
  static const int kTschchartinfolinedeprecated3DshadowFieldNumber = 310;
  inline const ::TSD::ShadowArchive& tschchartinfolinedeprecated3dshadow() const;
  inline ::TSD::ShadowArchive* mutable_tschchartinfolinedeprecated3dshadow();
  inline ::TSD::ShadowArchive* release_tschchartinfolinedeprecated3dshadow();
  inline void set_allocated_tschchartinfolinedeprecated3dshadow(::TSD::ShadowArchive* tschchartinfolinedeprecated3dshadow);

  // optional .TSD.ShadowArchive tschchartinfoareadeprecated3dshadow = 311;
  inline bool has_tschchartinfoareadeprecated3dshadow() const;
  inline void clear_tschchartinfoareadeprecated3dshadow();
  static const int kTschchartinfoareadeprecated3DshadowFieldNumber = 311;
  inline const ::TSD::ShadowArchive& tschchartinfoareadeprecated3dshadow() const;
  inline ::TSD::ShadowArchive* mutable_tschchartinfoareadeprecated3dshadow();
  inline ::TSD::ShadowArchive* release_tschchartinfoareadeprecated3dshadow();
  inline void set_allocated_tschchartinfoareadeprecated3dshadow(::TSD::ShadowArchive* tschchartinfoareadeprecated3dshadow);

  // optional .TSD.ShadowArchive tschchartinfopiedeprecated3dshadow = 312;
  inline bool has_tschchartinfopiedeprecated3dshadow() const;
  inline void clear_tschchartinfopiedeprecated3dshadow();
  static const int kTschchartinfopiedeprecated3DshadowFieldNumber = 312;
  inline const ::TSD::ShadowArchive& tschchartinfopiedeprecated3dshadow() const;
  inline ::TSD::ShadowArchive* mutable_tschchartinfopiedeprecated3dshadow();
  inline ::TSD::ShadowArchive* release_tschchartinfopiedeprecated3dshadow();
  inline void set_allocated_tschchartinfopiedeprecated3dshadow(::TSD::ShadowArchive* tschchartinfopiedeprecated3dshadow);
  ...
  static const int kTschchartinfodefault3DlightingpackageFieldNumber = 313;
  ...
  static const int kTschchartinfocolumn3DlightingpackageFieldNumber = 314;
  ...
  static const int kTschchartinfobar3DlightingpackageFieldNumber = 315;
  ...
  static const int kTschchartinfoline3DlightingpackageFieldNumber = 316;
  ...
  static const int kTschchartinfoarea3DlightingpackageFieldNumber = 317;
  ...
  static const int kTschchartinfopie3DlightingpackageFieldNumber = 318;
  ...
  inline bool has_tschchartinfodefaultdeprecated3dbeveledges() const;
  inline void clear_tschchartinfodefaultdeprecated3dbeveledges();
  static const int kTschchartinfodefaultdeprecated3DbeveledgesFieldNumber = 326;
  inline bool tschchartinfodefaultdeprecated3dbeveledges() const;
  inline void set_tschchartinfodefaultdeprecated3dbeveledges(bool value);

  // optional bool tschchartinfopiedeprecated3dbeveledges = 327;
  inline bool has_tschchartinfopiedeprecated3dbeveledges() const;
  inline void clear_tschchartinfopiedeprecated3dbeveledges();
  static const int kTschchartinfopiedeprecated3DbeveledgesFieldNumber = 327;
  inline bool tschchartinfopiedeprecated3dbeveledges() const;
  inline void set_tschchartinfopiedeprecated3dbeveledges(bool value);

  // optional bool tschchartinfobardeprecated3dbeveledges = 328;
  inline bool has_tschchartinfobardeprecated3dbeveledges() const;
  inline void clear_tschchartinfobardeprecated3dbeveledges();
  static const int kTschchartinfobardeprecated3DbeveledgesFieldNumber = 328;
  inline bool tschchartinfobardeprecated3dbeveledges() const;
  inline void set_tschchartinfobardeprecated3dbeveledges(bool value);

  // optional bool tschchartinfocolumndeprecated3dbeveledges = 329;
  inline bool has_tschchartinfocolumndeprecated3dbeveledges() const;
  inline void clear_tschchartinfocolumndeprecated3dbeveledges();
  static const int kTschchartinfocolumndeprecated3DbeveledgesFieldNumber = 329;
  inline bool tschchartinfocolumndeprecated3dbeveledges() const;
  inline void set_tschchartinfocolumndeprecated3dbeveledges(bool value);

  // optional int32 tschchartinfodefaultdeprecated3dbarshape = 330;
  inline bool has_tschchartinfodefaultdeprecated3dbarshape() const;
  inline void clear_tschchartinfodefaultdeprecated3dbarshape();
  static const int kTschchartinfodefaultdeprecated3DbarshapeFieldNumber = 330;
  inline ::google::protobuf::int32 tschchartinfodefaultdeprecated3dbarshape() const;
  inline void set_tschchartinfodefaultdeprecated3dbarshape(::google::protobuf::int32 value);
  ...
  static const int kTschchartinfodefault3DchartopacityFieldNumber = 335;
 ...
 private:
  ...
  inline void set_has_tschchartinfodefaultdeprecatedmasterfontfamily();
  inline void clear_has_tschchartinfodefaultdeprecatedmasterfontfamily();
  inline void set_has_tschchartinfodefaultdeprecatedmasterfontnamedsize();
  inline void clear_has_tschchartinfodefaultdeprecatedmasterfontnamedsize();
  inline void set_has_tschchartinfodefaultdeprecatedtrendlineequationparagraphstyleindex();
  inline void clear_has_tschchartinfodefaultdeprecatedtrendlineequationparagraphstyleindex();
  inline void set_has_tschchartinfodefaultdeprecatedtrendlinersquaredparagraphstyleindex();
  inline void clear_has_tschchartinfodefaultdeprecatedtrendlinersquaredparagraphstyleindex();
  inline void set_has_tschchartinfodefaultdeprecatedtrendlineequationshadow();
  inline void clear_has_tschchartinfodefaultdeprecatedtrendlineequationshadow();
  inline void set_has_tschchartinfodefaultdeprecatedtrendlinersquaredshadow();
  inline void clear_has_tschchartinfodefaultdeprecatedtrendlinersquaredshadow();
  inline void set_has_tschchartinfodefaultdeprecatedtrendlineequationopacity();
  inline void clear_has_tschchartinfodefaultdeprecatedtrendlineequationopacity();
  inline void set_has_tschchartinfodefaultdeprecatedtrendlinersquaredopacity();
  inline void clear_has_tschchartinfodefaultdeprecatedtrendlinersquaredopacity();
  inline void set_has_tschchartinfobardeprecated3dshadow();
  inline void clear_has_tschchartinfobardeprecated3dshadow();
  inline void set_has_tschchartinfocolumndeprecated3dshadow();
  inline void clear_has_tschchartinfocolumndeprecated3dshadow();
  inline void set_has_tschchartinfolinedeprecated3dshadow();
  inline void clear_has_tschchartinfolinedeprecated3dshadow();
  inline void set_has_tschchartinfoareadeprecated3dshadow();
  inline void clear_has_tschchartinfoareadeprecated3dshadow();
  inline void set_has_tschchartinfopiedeprecated3dshadow();
  inline void clear_has_tschchartinfopiedeprecated3dshadow();
  ...
  inline void set_has_tschchartinfodefaultdeprecated3dbeveledges();
  inline void clear_has_tschchartinfodefaultdeprecated3dbeveledges();
  inline void set_has_tschchartinfopiedeprecated3dbeveledges();
  inline void clear_has_tschchartinfopiedeprecated3dbeveledges();
  inline void set_has_tschchartinfobardeprecated3dbeveledges();
  inline void clear_has_tschchartinfobardeprecated3dbeveledges();
  inline void set_has_tschchartinfocolumndeprecated3dbeveledges();
  inline void clear_has_tschchartinfocolumndeprecated3dbeveledges();
  inline void set_has_tschchartinfodefaultdeprecated3dbarshape();
  inline void clear_has_tschchartinfodefaultdeprecated3dbarshape();
  ...
  ::std::string* tschchartinfodefaultdeprecatedmasterfontfamily_;
  ::google::protobuf::int32 tschchartinfodefaulttitleparagraphstyleindex_;
  ::google::protobuf::int32 tschchartinfodefaultdeprecatedmasterfontnamedsize_;
  ::google::protobuf::int32 tschchartinfodefaultdeprecatedtrendlineequationparagraphstyleindex_;
  ::google::protobuf::int32 tschchartinfodefaultdeprecatedtrendlinersquaredparagraphstyleindex_;
  ...
  ::google::protobuf::int32 tschchartinfodefaultdeprecated3dbarshape_;
...
class ChartNonStyleArchive : public ::google::protobuf::Message {
 public:
  ...
  static const int kTschchartinfodefaulttitleFieldNumber = 10;
  ...
  static const int kTschchartinfodefaultshowlegendFieldNumber = 11;
  ...
  static const int kTschchartinfodefaultpiestartangleFieldNumber = 12;
  ...
  static const int kTschchartinfodefaultshowtitleFieldNumber = 13;
  ...
  inline bool has_tschchartinfodefaultdeprecatedagainmasterfontnamedsize() const;
  inline void clear_tschchartinfodefaultdeprecatedagainmasterfontnamedsize();
  static const int kTschchartinfodefaultdeprecatedagainmasterfontnamedsizeFieldNumber = 25;
  inline ::google::protobuf::int32 tschchartinfodefaultdeprecatedagainmasterfontnamedsize() const;
  inline void set_tschchartinfodefaultdeprecatedagainmasterfontnamedsize(::google::protobuf::int32 value);
  ...
  static const int kTschchartinfodefault3DrotationFieldNumber = 300;
  ...
  static const int kTschchartinfodefault3DscaleFieldNumber = 301;
  ...
  static const int kTschchartinfocolumn3DscaleFieldNumber = 302;
  ...
  static const int kTschchartinfobar3DscaleFieldNumber = 303;
  ...
  static const int kTschchartinfoline3DscaleFieldNumber = 304;
  ...
  static const int kTschchartinfoarea3DscaleFieldNumber = 305;
  ...
  static const int kTschchartinfopie3DscaleFieldNumber = 306;
  ...
  static const int kTschchartinfodefault3DviewportFieldNumber = 313;
  ...
  inline bool has_tschchartinfodefaultdeprecated3dlightingpackage() const;
  inline void clear_tschchartinfodefaultdeprecated3dlightingpackage();
  static const int kTschchartinfodefaultdeprecated3DlightingpackageFieldNumber = 320;
  inline const ::TSCH::Chart3DLightingPackageArchive& tschchartinfodefaultdeprecated3dlightingpackage() const;
  inline ::TSCH::Chart3DLightingPackageArchive* mutable_tschchartinfodefaultdeprecated3dlightingpackage();
  inline ::TSCH::Chart3DLightingPackageArchive* release_tschchartinfodefaultdeprecated3dlightingpackage();
  inline void set_allocated_tschchartinfodefaultdeprecated3dlightingpackage(::TSCH::Chart3DLightingPackageArchive* tschchartinfodefaultdeprecated3dlightingpackage);

  // optional .TSCH.Chart3DLightingPackageArchive tschchartinfocolumndeprecated3dlightingpackage = 321;
  inline bool has_tschchartinfocolumndeprecated3dlightingpackage() const;
  inline void clear_tschchartinfocolumndeprecated3dlightingpackage();
  static const int kTschchartinfocolumndeprecated3DlightingpackageFieldNumber = 321;
  inline const ::TSCH::Chart3DLightingPackageArchive& tschchartinfocolumndeprecated3dlightingpackage() const;
  inline ::TSCH::Chart3DLightingPackageArchive* mutable_tschchartinfocolumndeprecated3dlightingpackage();
  inline ::TSCH::Chart3DLightingPackageArchive* release_tschchartinfocolumndeprecated3dlightingpackage();
  inline void set_allocated_tschchartinfocolumndeprecated3dlightingpackage(::TSCH::Chart3DLightingPackageArchive* tschchartinfocolumndeprecated3dlightingpackage);

  // optional .TSCH.Chart3DLightingPackageArchive tschchartinfobardeprecated3dlightingpackage = 322;
  inline bool has_tschchartinfobardeprecated3dlightingpackage() const;
  inline void clear_tschchartinfobardeprecated3dlightingpackage();
  static const int kTschchartinfobardeprecated3DlightingpackageFieldNumber = 322;
  inline const ::TSCH::Chart3DLightingPackageArchive& tschchartinfobardeprecated3dlightingpackage() const;
  inline ::TSCH::Chart3DLightingPackageArchive* mutable_tschchartinfobardeprecated3dlightingpackage();
  inline ::TSCH::Chart3DLightingPackageArchive* release_tschchartinfobardeprecated3dlightingpackage();
  inline void set_allocated_tschchartinfobardeprecated3dlightingpackage(::TSCH::Chart3DLightingPackageArchive* tschchartinfobardeprecated3dlightingpackage);

  // optional .TSCH.Chart3DLightingPackageArchive tschchartinfolinedeprecated3dlightingpackage = 323;
  inline bool has_tschchartinfolinedeprecated3dlightingpackage() const;
  inline void clear_tschchartinfolinedeprecated3dlightingpackage();
  static const int kTschchartinfolinedeprecated3DlightingpackageFieldNumber = 323;
  inline const ::TSCH::Chart3DLightingPackageArchive& tschchartinfolinedeprecated3dlightingpackage() const;
  inline ::TSCH::Chart3DLightingPackageArchive* mutable_tschchartinfolinedeprecated3dlightingpackage();
  inline ::TSCH::Chart3DLightingPackageArchive* release_tschchartinfolinedeprecated3dlightingpackage();
  inline void set_allocated_tschchartinfolinedeprecated3dlightingpackage(::TSCH::Chart3DLightingPackageArchive* tschchartinfolinedeprecated3dlightingpackage);

  // optional .TSCH.Chart3DLightingPackageArchive tschchartinfoareadeprecated3dlightingpackage = 324;
  inline bool has_tschchartinfoareadeprecated3dlightingpackage() const;
  inline void clear_tschchartinfoareadeprecated3dlightingpackage();
  static const int kTschchartinfoareadeprecated3DlightingpackageFieldNumber = 324;
  inline const ::TSCH::Chart3DLightingPackageArchive& tschchartinfoareadeprecated3dlightingpackage() const;
  inline ::TSCH::Chart3DLightingPackageArchive* mutable_tschchartinfoareadeprecated3dlightingpackage();
  inline ::TSCH::Chart3DLightingPackageArchive* release_tschchartinfoareadeprecated3dlightingpackage();
  inline void set_allocated_tschchartinfoareadeprecated3dlightingpackage(::TSCH::Chart3DLightingPackageArchive* tschchartinfoareadeprecated3dlightingpackage);

  // optional .TSCH.Chart3DLightingPackageArchive tschchartinfopiedeprecated3dlightingpackage = 325;
  inline bool has_tschchartinfopiedeprecated3dlightingpackage() const;
  inline void clear_tschchartinfopiedeprecated3dlightingpackage();
  static const int kTschchartinfopiedeprecated3DlightingpackageFieldNumber = 325;
  inline const ::TSCH::Chart3DLightingPackageArchive& tschchartinfopiedeprecated3dlightingpackage() const;
  inline ::TSCH::Chart3DLightingPackageArchive* mutable_tschchartinfopiedeprecated3dlightingpackage();
  inline ::TSCH::Chart3DLightingPackageArchive* release_tschchartinfopiedeprecated3dlightingpackage();
  inline void set_allocated_tschchartinfopiedeprecated3dlightingpackage(::TSCH::Chart3DLightingPackageArchive* tschchartinfopiedeprecated3dlightingpackage);
  ...
  static const int kTschchartinfodefaultskiphiddendataFieldNumber = 326;
  ...
  static const int kTschchartinfodefault3DbeveledgesFieldNumber = 327;
  ...
  static const int kTschchartinfodefault3DbarshapeFieldNumber = 336;
  ...
  static const int kTschchartinfodefault3DintersetdepthgapFieldNumber = 331;
 ...
 private:
  ...
  inline void set_has_tschchartinfodefaultdeprecatedagainmasterfontnamedsize();
  inline void clear_has_tschchartinfodefaultdeprecatedagainmasterfontnamedsize();
  ...
  inline void set_has_tschchartinfodefaultdeprecated3dlightingpackage();
  inline void clear_has_tschchartinfodefaultdeprecated3dlightingpackage();
  inline void set_has_tschchartinfocolumndeprecated3dlightingpackage();
  inline void clear_has_tschchartinfocolumndeprecated3dlightingpackage();
  inline void set_has_tschchartinfobardeprecated3dlightingpackage();
  inline void clear_has_tschchartinfobardeprecated3dlightingpackage();
  inline void set_has_tschchartinfolinedeprecated3dlightingpackage();
  inline void clear_has_tschchartinfolinedeprecated3dlightingpackage();
  inline void set_has_tschchartinfoareadeprecated3dlightingpackage();
  inline void clear_has_tschchartinfoareadeprecated3dlightingpackage();
  inline void set_has_tschchartinfopiedeprecated3dlightingpackage();
  inline void clear_has_tschchartinfopiedeprecated3dlightingpackage();
  ...
  ::google::protobuf::int32 tschchartinfodefaultdeprecatedagainmasterfontnamedsize_;
...
class LegendStyleArchive : public ::google::protobuf::Message {
 public:
  ...
  static const int kTschlegendmodeldefaultfillFieldNumber = 10;
  ...
  static const int kTschlegendmodeldefaultstrokeFieldNumber = 11;
  ...
  static const int kTschlegendmodeldefaultshadowFieldNumber = 14;
  ...
  static const int kTschlegendmodeldefaultopacityFieldNumber = 15;
  ...
  static const int kTschlegendmodeldefaultlabelparagraphstyleindexFieldNumber = 16;
...
class ChartAxisStyleArchive : public ::google::protobuf::Message {
 public:
  ...
  static const int kTschchartaxisvalueshowmajorgridlinesFieldNumber = 10;
  ...
  static const int kTschchartaxisvalueshowminorgridlinesFieldNumber = 11;
  ...
  static const int kTschchartaxisvaluemajorgridlinestrokeFieldNumber = 12;
  ...
  static const int kTschchartaxisvalueminorgridlinestrokeFieldNumber = 13;
  ...
  static const int kTschchartaxisvaluetickmarklocationFieldNumber = 14;
  ...
  static const int kTschchartaxisvalueshowmajortickmarksFieldNumber = 15;
  ...
  static const int kTschchartaxisvalueshowminortickmarksFieldNumber = 16;
  ...
  static const int kTschchartaxisvaluelabelsorientationFieldNumber = 17;
  ...
  static const int kTschchartaxisvalueshowminimumlabelFieldNumber = 18;
  ...
  static const int kTschchartaxisvaluemajorgridlineshadowFieldNumber = 21;
  ...
  static const int kTschchartaxisvalueminorgridlineshadowFieldNumber = 22;
  ...
  static const int kTschchartaxisvaluemajorgridlineopacityFieldNumber = 23;
  ...
  static const int kTschchartaxisvalueminorgridlineopacityFieldNumber = 24;
  ...
  static const int kTschchartaxiscategoryshowmajorgridlinesFieldNumber = 50;
  ...
  static const int kTschchartaxiscategoryshowminorgridlinesFieldNumber = 51;
  ...
  static const int kTschchartaxiscategorymajorgridlinestrokeFieldNumber = 52;
  ...
  static const int kTschchartaxiscategoryminorgridlinestrokeFieldNumber = 53;
  ...
  static const int kTschchartaxiscategorytickmarklocationFieldNumber = 54;
  ...
  static const int kTschchartaxiscategoryshowmajortickmarksFieldNumber = 55;
  ...
  static const int kTschchartaxiscategoryshowminortickmarksFieldNumber = 56;
  ...
  static const int kTschchartaxiscategorylabelsorientationFieldNumber = 57;
  ...
  static const int kTschchartaxiscategoryhorizontalspacingFieldNumber = 58;
  ...
  static const int kTschchartaxiscategoryverticalspacingFieldNumber = 59;
  ...
  static const int kTschchartaxiscategoryshowlastlabelFieldNumber = 60;
  ...
  static const int kTschchartaxiscategorymajorgridlineshadowFieldNumber = 63;
  ...
  static const int kTschchartaxiscategoryminorgridlineshadowFieldNumber = 64;
  ...
  static const int kTschchartaxiscategorymajorgridlineopacityFieldNumber = 65;
  ...
  static const int kTschchartaxiscategoryminorgridlineopacityFieldNumber = 66;
  ...
  static const int kTschchartaxiscategoryshowaxisFieldNumber = 67;
  ...
  static const int kTschchartaxisdefaultlabelsorientationFieldNumber = 102;
  ...
  static const int kTschchartaxisdefaulttitleparagraphstyleindexFieldNumber = 110;
  ...
  static const int kTschchartaxisdefaultlabelparagraphstyleindexFieldNumber = 111;
  ...
  static const int kTschchartaxisvaluetitleparagraphstyleindexFieldNumber = 112;
  ...
  static const int kTschchartaxisvaluelabelparagraphstyleindexFieldNumber = 113;
  ...
  static const int kTschchartaxiscategorytitleparagraphstyleindexFieldNumber = 114;
  ...
  static const int kTschchartaxiscategorylabelparagraphstyleindexFieldNumber = 115;
  ...
  static const int kTschchartaxisvalue3DgridlinestrokeFieldNumber = 331;
  ...
  static const int kTschchartaxiscategory3DgridlinestrokeFieldNumber = 332;
  ...
  static const int kTschchartaxisvalue3DgridlineopacityFieldNumber = 333;
  ...
  static const int kTschchartaxiscategory3DgridlineopacityFieldNumber = 334;
...
class ChartAxisNonStyleArchive : public ::google::protobuf::Message {
 public:
  ...
  static const int kTschchartaxisdefaultuserminFieldNumber = 11;
  ...
  static const int kTschchartaxisdefaultusermaxFieldNumber = 12;
  ...
  static const int kTschchartaxisdefaultnumberformatFieldNumber = 13;
  inline const ::TSCH::PreUFF::ChartsNumberFormatArchive& tschchartaxisdefaultnumberformat() const;
  inline ::TSCH::PreUFF::ChartsNumberFormatArchive* mutable_tschchartaxisdefaultnumberformat();
  inline ::TSCH::PreUFF::ChartsNumberFormatArchive* release_tschchartaxisdefaultnumberformat();
  inline void set_allocated_tschchartaxisdefaultnumberformat(::TSCH::PreUFF::ChartsNumberFormatArchive* tschchartaxisdefaultnumberformat);
  ...
  static const int kTschchartaxisdefaultshowlabelsFieldNumber = 14;
  ...
  static const int kTschchartaxisvaluenumberofminorgridlinesFieldNumber = 50;
  ...
  static const int kTschchartaxisvaluescaleFieldNumber = 51;
  ...
  static const int kTschchartaxisvaluenumberofdecadesFieldNumber = 52;
  ...
  static const int kTschchartaxisvalueshowlabelsFieldNumber = 53;
  ...
  static const int kTschchartaxisvalueshowtitleFieldNumber = 54;
  ...
  static const int kTschchartaxisvaluenumberofmajorgridlinesFieldNumber = 55;
  ...
  static const int kTschchartaxisvaluetitleFieldNumber = 56;
  ...
  static const int kTschchartaxiscategoryshowlabelsFieldNumber = 100;
  ...
  static const int kTschchartaxiscategoryshowserieslabelsFieldNumber = 101;
  ...
  static const int kTschchartaxiscategoryshowtitleFieldNumber = 102;
  ...
  static const int kTschchartaxiscategorytitleFieldNumber = 103;
  ...
  static const int kTschchartaxisdefaultnumberformattypeFieldNumber = 120;
  ...
  static const int kTschchartaxisdefault3DlabelpositionFieldNumber = 336;
  ...
  static const int kTschchartaxiscategoryplottoedgesFieldNumber = 116;
...
class ChartSeriesStyleArchive : public ::google::protobuf::Message {
 public:
  ...
  static const int kTschchartseriesdefaulttrendlineequationparagraphstyleindexFieldNumber = 201;
  ...
  static const int kTschchartseriesdefaulttrendlinersquaredparagraphstyleindexFieldNumber = 202;
  ...
  static const int kTschchartseriesdefaulttrendlineequationopacityFieldNumber = 205;
  ...
  static const int kTschchartseriesdefaulttrendlinersquaredopacityFieldNumber = 206;
  ...
  static const int kTschchartseriesbarfillFieldNumber = 10;
  ...
  static const int kTschchartseriesbarstrokeFieldNumber = 11;
  ...
  static const int kTschchartseriesbarvaluelabelpositionFieldNumber = 13;
  ...
  static const int kTschchartserieslinestrokeFieldNumber = 16;
  ...
  static const int kTschchartserieslinesymbolfillFieldNumber = 17;
  ...
  static const int kTschchartserieslinesymbolstrokeFieldNumber = 18;
  ...
  static const int kTschchartserieslinesymbolsizeFieldNumber = 20;
  ...
  static const int kTschchartserieslinevaluelabelpositionFieldNumber = 22;
  ...
  static const int kTschchartseriesareafillFieldNumber = 25;
  ...
  static const int kTschchartseriesareastrokeFieldNumber = 26;
  ...
  static const int kTschchartseriesareavaluelabelpositionFieldNumber = 28;
  ...
  static const int kTschchartseriesareasymbolfillFieldNumber = 29;
  ...
  static const int kTschchartseriesareasymbolstrokeFieldNumber = 30;
  ...
  static const int kTschchartseriesareasymbolsizeFieldNumber = 32;
  ...
  static const int kTschchartseriespiefillFieldNumber = 35;
  ...
  static const int kTschchartseriespiestrokeFieldNumber = 36;
  ...
  static const int kTschchartseriesscatterstrokeFieldNumber = 40;
  ...
  static const int kTschchartseriesscattersymbolfillFieldNumber = 41;
  ...
  static const int kTschchartseriesscattersymbolstrokeFieldNumber = 42;
  ...
  static const int kTschchartseriesscattersymbolsizeFieldNumber = 44;
  ...
  static const int kTschchartseriesscattervaluelabelpositionFieldNumber = 46;
  ...
  static const int kTschchartseriesdefaultfillFieldNumber = 50;
  ...
  static const int kTschchartseriesdefaultvaluelabelpositionFieldNumber = 52;
  ...
  inline bool has_tschchartseriespiedeprecatedserieslabelson() const;
  inline void clear_tschchartseriespiedeprecatedserieslabelson();
  static const int kTschchartseriespiedeprecatedserieslabelsonFieldNumber = 60;
  inline bool tschchartseriespiedeprecatedserieslabelson() const;
  inline void set_tschchartseriespiedeprecatedserieslabelson(bool value);
  ...
  static const int kTschchartseriescolumnfillFieldNumber = 62;
  ...
  static const int kTschchartseriespieshadowFieldNumber = 100;
  ...
  static const int kTschchartseriesbarshadowFieldNumber = 101;
  ...
  static const int kTschchartseriesareashadowFieldNumber = 102;
  ...
  static const int kTschchartseriesscattershadowFieldNumber = 103;
  ...
  static const int kTschchartseriesmixedlineshadowFieldNumber = 104;
  ...
  static const int kTschchartseriesmixedareashadowFieldNumber = 105;
  ...
  static const int kTschchartseriesmixedcolumnshadowFieldNumber = 106;
  ...
  static const int kTschchartserieslineshadowFieldNumber = 107;
  ...
  static const int kTschchartseriesdefaultshadowFieldNumber = 108;
  ...
  static const int kTschchartseriesbubblesymbolfillFieldNumber = 207;
  ...
  static const int kTschchartseriesbubblestrokeFieldNumber = 211;
  ...
  static const int kTschchartseriesbubblesymbolstrokeFieldNumber = 212;
  ...
  static const int kTschchartseriesbubblevaluelabelpositionFieldNumber = 213;
  ...
  static const int kTschchartseriesbubbleshadowFieldNumber = 214;
  ...
  static const int kTschchartseriesbubblesymbolfilluseseriesstrokeFieldNumber = 215;
  ...
  static const int kTschchartseries3DbarshadowFieldNumber = 306;
  ...
  static const int kTschchartseries3DcolumnshadowFieldNumber = 307;
  ...
  static const int kTschchartseries3DlineshadowFieldNumber = 308;
  ...
  static const int kTschchartseries3DareashadowFieldNumber = 309;
  ...
  static const int kTschchartseries3DpieshadowFieldNumber = 310;
  ...
  static const int kTschchartseriesdefaultlabelparagraphstyleindexFieldNumber = 110;
  ...
  static const int kTschchartseriesbarlabelparagraphstyleindexFieldNumber = 111;
  ...
  static const int kTschchartserieslinelabelparagraphstyleindexFieldNumber = 112;
  ...
  static const int kTschchartseriesarealabelparagraphstyleindexFieldNumber = 113;
  ...
  static const int kTschchartseriespielabelparagraphstyleindexFieldNumber = 114;
  ...
  static const int kTschchartseriesmixedlabelparagraphstyleindexFieldNumber = 115;
  ...
  static const int kTschchartseriesdefaultopacityFieldNumber = 116;
  ...
  static const int kTschchartserieslinesymbolfilluseseriesstrokeFieldNumber = 117;
  ...
  static const int kTschchartseriesareasymbolfilluseseriesstrokeFieldNumber = 118;
  ...
  static const int kTschchartseriesscattersymbolfilluseseriesstrokeFieldNumber = 119;
  ...
  static const int kTschchartseriesmixedlinesymbolfilluseseriesstrokeFieldNumber = 120;
  ...
  static const int kTschchartseriesmixedareasymbolfilluseseriesstrokeFieldNumber = 121;
  ...
  static const int kTschchartserieslinesymbolfilluseseriesfillFieldNumber = 122;
  ...
  static const int kTschchartseriesareasymbolfilluseseriesfillFieldNumber = 123;
  ...
  static const int kTschchartseriesmixedlinesymbolfilluseseriesfillFieldNumber = 124;
  ...
  static const int kTschchartseriesmixedareasymbolfilluseseriesfillFieldNumber = 125;
  ...
  static const int kTschchartseriesmixedcolumnfillFieldNumber = 130;
  ...
  static const int kTschchartseriesmixedareafillFieldNumber = 131;
  ...
  static const int kTschchartseriesmixedcolumnstrokeFieldNumber = 132;
  ...
  static const int kTschchartseriesmixedlinestrokeFieldNumber = 133;
  ...
  static const int kTschchartseriesmixedareastrokeFieldNumber = 134;
  ...
  static const int kTschchartseriesmixedlinesymbolsizeFieldNumber = 135;
  ...
  static const int kTschchartseriesmixedareasymbolsizeFieldNumber = 136;
  ...
  static const int kTschchartseriesmixedlinesymbolfillFieldNumber = 137;
  ...
  static const int kTschchartseriesmixedareasymbolfillFieldNumber = 138;
  ...
  static const int kTschchartseriesmixedlinesymbolstrokeFieldNumber = 139;
  ...
  static const int kTschchartseriesmixedareasymbolstrokeFieldNumber = 140;
  ...
  static const int kTschchartseriesmixedcolumnvaluelabelpositionFieldNumber = 141;
  ...
  static const int kTschchartseriesmixedlinevaluelabelpositionFieldNumber = 142;
  ...
  static const int kTschchartseriesmixedareavaluelabelpositionFieldNumber = 143;
  ...
  static const int kTschchartseriesdefaultoutsidelabelparagraphstyleindexFieldNumber = 150;
  ...
  static const int kTschchartseriesbaroutsidelabelparagraphstyleindexFieldNumber = 151;
  ...
  static const int kTschchartseriesareaoutsidelabelparagraphstyleindexFieldNumber = 153;
  ...
  static const int kTschchartseriespieoutsidelabelparagraphstyleindexFieldNumber = 154;
  ...
  static const int kTschchartseriesmixedoutsidelabelparagraphstyleindexFieldNumber = 155;
  ...
  static const int kTschchartseriesstackedbarvaluelabelpositionFieldNumber = 156;
  ...
  static const int kTschchartseriesstackedareavaluelabelpositionFieldNumber = 157;
  ...
  static const int kTschchartseriesdefaulttrendlinestrokeFieldNumber = 167;
  ...
  static const int kTschchartseriesdefaulttrendlineshadowFieldNumber = 168;
  ...
  static const int kTschchartseriesdefaulterrorbarshadowFieldNumber = 180;
  ...
  static const int kTschchartseriesdefaulterrorbarstrokeFieldNumber = 181;
  ...
  static const int kTschchartseriesdefaulterrorbarstrokescatterxFieldNumber = 182;
  ...
  static const int kTschchartseriesdefaulterrorbarlineendFieldNumber = 183;
  ...
  static const int kTschchartseriesdefaulterrorbarlineendscatterxFieldNumber = 184;
  ...
  inline bool has_tschchartseriesdefaultdeprecated3dfill() const;
  inline void clear_tschchartseriesdefaultdeprecated3dfill();
  static const int kTschchartseriesdefaultdeprecated3DfillFieldNumber = 300;
  inline const ::TSCH::DEPRECATEDChart3DFillArchive& tschchartseriesdefaultdeprecated3dfill() const;
  inline ::TSCH::DEPRECATEDChart3DFillArchive* mutable_tschchartseriesdefaultdeprecated3dfill();
  inline ::TSCH::DEPRECATEDChart3DFillArchive* release_tschchartseriesdefaultdeprecated3dfill();
  inline void set_allocated_tschchartseriesdefaultdeprecated3dfill(::TSCH::DEPRECATEDChart3DFillArchive* tschchartseriesdefaultdeprecated3dfill);

  // optional .TSCH.DEPRECATEDChart3DFillArchive tschchartseriesbardeprecated3dfill = 301;
  inline bool has_tschchartseriesbardeprecated3dfill() const;
  inline void clear_tschchartseriesbardeprecated3dfill();
  static const int kTschchartseriesbardeprecated3DfillFieldNumber = 301;
  inline const ::TSCH::DEPRECATEDChart3DFillArchive& tschchartseriesbardeprecated3dfill() const;
  inline ::TSCH::DEPRECATEDChart3DFillArchive* mutable_tschchartseriesbardeprecated3dfill();
  inline ::TSCH::DEPRECATEDChart3DFillArchive* release_tschchartseriesbardeprecated3dfill();
  inline void set_allocated_tschchartseriesbardeprecated3dfill(::TSCH::DEPRECATEDChart3DFillArchive* tschchartseriesbardeprecated3dfill);

  // optional .TSCH.DEPRECATEDChart3DFillArchive tschchartseriescolumndeprecated3dfill = 302;
  inline bool has_tschchartseriescolumndeprecated3dfill() const;
  inline void clear_tschchartseriescolumndeprecated3dfill();
  static const int kTschchartseriescolumndeprecated3DfillFieldNumber = 302;
  inline const ::TSCH::DEPRECATEDChart3DFillArchive& tschchartseriescolumndeprecated3dfill() const;
  inline ::TSCH::DEPRECATEDChart3DFillArchive* mutable_tschchartseriescolumndeprecated3dfill();
  inline ::TSCH::DEPRECATEDChart3DFillArchive* release_tschchartseriescolumndeprecated3dfill();
  inline void set_allocated_tschchartseriescolumndeprecated3dfill(::TSCH::DEPRECATEDChart3DFillArchive* tschchartseriescolumndeprecated3dfill);

  // optional .TSCH.DEPRECATEDChart3DFillArchive tschchartserieslinedeprecated3dfill = 303;
  inline bool has_tschchartserieslinedeprecated3dfill() const;
  inline void clear_tschchartserieslinedeprecated3dfill();
  static const int kTschchartserieslinedeprecated3DfillFieldNumber = 303;
  inline const ::TSCH::DEPRECATEDChart3DFillArchive& tschchartserieslinedeprecated3dfill() const;
  inline ::TSCH::DEPRECATEDChart3DFillArchive* mutable_tschchartserieslinedeprecated3dfill();
  inline ::TSCH::DEPRECATEDChart3DFillArchive* release_tschchartserieslinedeprecated3dfill();
  inline void set_allocated_tschchartserieslinedeprecated3dfill(::TSCH::DEPRECATEDChart3DFillArchive* tschchartserieslinedeprecated3dfill);

  // optional .TSCH.DEPRECATEDChart3DFillArchive tschchartseriesareadeprecated3dfill = 304;
  inline bool has_tschchartseriesareadeprecated3dfill() const;
  inline void clear_tschchartseriesareadeprecated3dfill();
  static const int kTschchartseriesareadeprecated3DfillFieldNumber = 304;
  inline const ::TSCH::DEPRECATEDChart3DFillArchive& tschchartseriesareadeprecated3dfill() const;
  inline ::TSCH::DEPRECATEDChart3DFillArchive* mutable_tschchartseriesareadeprecated3dfill();
  inline ::TSCH::DEPRECATEDChart3DFillArchive* release_tschchartseriesareadeprecated3dfill();
  inline void set_allocated_tschchartseriesareadeprecated3dfill(::TSCH::DEPRECATEDChart3DFillArchive* tschchartseriesareadeprecated3dfill);

  // optional .TSCH.DEPRECATEDChart3DFillArchive tschchartseriespiedeprecated3dfill = 305;
  inline bool has_tschchartseriespiedeprecated3dfill() const;
  inline void clear_tschchartseriespiedeprecated3dfill();
  static const int kTschchartseriespiedeprecated3DfillFieldNumber = 305;
  inline const ::TSCH::DEPRECATEDChart3DFillArchive& tschchartseriespiedeprecated3dfill() const;
  inline ::TSCH::DEPRECATEDChart3DFillArchive* mutable_tschchartseriespiedeprecated3dfill();
  inline ::TSCH::DEPRECATEDChart3DFillArchive* release_tschchartseriespiedeprecated3dfill();
  inline void set_allocated_tschchartseriespiedeprecated3dfill(::TSCH::DEPRECATEDChart3DFillArchive* tschchartseriespiedeprecated3dfill);
  ...
  static const int kTschchartseries3DbarfillFieldNumber = 320;
  ...
  static const int kTschchartseries3DcolumnfillFieldNumber = 321;
  ...
  static const int kTschchartseries3DlinefillFieldNumber = 322;
  ...
  static const int kTschchartseries3DareafillFieldNumber = 323;
  ...
  static const int kTschchartseries3DpiefillFieldNumber = 324;
 ...
 private:
  ...
  inline void set_has_tschchartseriespiedeprecatedserieslabelson();
  inline void clear_has_tschchartseriespiedeprecatedserieslabelson();
  ...
  inline void set_has_tschchartseriesdefaultdeprecated3dfill();
  inline void clear_has_tschchartseriesdefaultdeprecated3dfill();
  inline void set_has_tschchartseriesbardeprecated3dfill();
  inline void clear_has_tschchartseriesbardeprecated3dfill();
  inline void set_has_tschchartseriescolumndeprecated3dfill();
  inline void clear_has_tschchartseriescolumndeprecated3dfill();
  inline void set_has_tschchartserieslinedeprecated3dfill();
  inline void clear_has_tschchartserieslinedeprecated3dfill();
  inline void set_has_tschchartseriesareadeprecated3dfill();
  inline void clear_has_tschchartseriesareadeprecated3dfill();
  inline void set_has_tschchartseriespiedeprecated3dfill();
  inline void clear_has_tschchartseriespiedeprecated3dfill();
  ...
  mutable int _cached_size_;
  ::google::protobuf::uint32 _has_bits_[(105 + 31) / 32];
...
class ChartSeriesNonStyleArchive : public ::google::protobuf::Message {
 public:
  ...
  static const int kTschchartseriesdefaultnumberformatFieldNumber = 10;
  inline const ::TSCH::PreUFF::ChartsNumberFormatArchive& tschchartseriesdefaultnumberformat() const;
  inline ::TSCH::PreUFF::ChartsNumberFormatArchive* mutable_tschchartseriesdefaultnumberformat();
  inline ::TSCH::PreUFF::ChartsNumberFormatArchive* release_tschchartseriesdefaultnumberformat();
  inline void set_allocated_tschchartseriesdefaultnumberformat(::TSCH::PreUFF::ChartsNumberFormatArchive* tschchartseriesdefaultnumberformat);
  ...
  static const int kTschchartseriesdefaultnumberformattypeFieldNumber = 11;
  ...
  static const int kTschchartseriesbarshowvaluelabelsFieldNumber = 12;
  ...
  static const int kTschchartserieslinesymboltypeFieldNumber = 19;
  ...
  static const int kTschchartserieslineshowsymbolFieldNumber = 20;
  ...
  static const int kTschchartserieslineshowvaluelabelsFieldNumber = 21;
  ...
  static const int kTschchartseriesareashowvaluelabelsFieldNumber = 27;
  ...
  static const int kTschchartserieslinelinetypeFieldNumber = 30;
  ...
  static const int kTschchartseriesareasymboltypeFieldNumber = 31;
  ...
  static const int kTschchartseriespieshowvaluelabelsFieldNumber = 37;
  ...
  static const int kTschchartseriespiewedgeexplosionFieldNumber = 50;
  ...
  static const int kTschchartseriesdefaultshowvaluelabelsFieldNumber = 51;
  ...
  static const int kTschchartseriespienumberformatFieldNumber = 52;
  inline const ::TSCH::PreUFF::ChartsNumberFormatArchive& tschchartseriespienumberformat() const;
  inline ::TSCH::PreUFF::ChartsNumberFormatArchive* mutable_tschchartseriespienumberformat();
  inline ::TSCH::PreUFF::ChartsNumberFormatArchive* release_tschchartseriespienumberformat();
  inline void set_allocated_tschchartseriespienumberformat(::TSCH::PreUFF::ChartsNumberFormatArchive* tschchartseriespienumberformat);
  ...
  static const int kTschchartseriespienumberformattypeFieldNumber = 53;
  ...
  static const int kTschchartseriespielabelexplosionFieldNumber = 54;
  ...
  static const int kTschchartseriesmixedlineshowsymbolFieldNumber = 58;
  ...
  static const int kTschchartseriesmixedareashowsymbolFieldNumber = 59;
  ...
  static const int kTschchartseriesmixedlinesymboltypeFieldNumber = 60;
  ...
  static const int kTschchartseriesmixedareasymboltypeFieldNumber = 61;
  ...
  static const int kTschchartseriesmixedshowvaluelabelsFieldNumber = 62;
  ...
  static const int kTschchartseriesmixedlinelinetypeFieldNumber = 63;
  ...
  static const int kTschchartseriesdefaultyaxisordinalFieldNumber = 65;
  ...
  static const int kTschchartseriespieshowserieslabelsFieldNumber = 66;
  ...
  static const int kTschchartseriesscattershowsymbolFieldNumber = 69;
  ...
  static const int kTschchartseriesscattersymboltypeFieldNumber = 70;
  ...
  static const int kTschchartseriesscatterlinetypeFieldNumber = 71;
  ...
  static const int kTschchartseriesscattershowlineFieldNumber = 72;
  ...
  static const int kTschchartseriesstackedpercentnumberformatFieldNumber = 90;
  inline const ::TSCH::PreUFF::ChartsNumberFormatArchive& tschchartseriesstackedpercentnumberformat() const;
  inline ::TSCH::PreUFF::ChartsNumberFormatArchive* mutable_tschchartseriesstackedpercentnumberformat();
  inline ::TSCH::PreUFF::ChartsNumberFormatArchive* release_tschchartseriesstackedpercentnumberformat();
  inline void set_allocated_tschchartseriesstackedpercentnumberformat(::TSCH::PreUFF::ChartsNumberFormatArchive* tschchartseriesstackedpercentnumberformat);
  ...
  static const int kTschchartseriesdefaultseriestypeFieldNumber = 126;
  ...
  static const int kTschchartseriesdefaulttrendlinetypeFieldNumber = 160;
  ...
  static const int kTschchartseriesdefaulttrendlineorderFieldNumber = 161;
  ...
  static const int kTschchartseriesdefaulttrendlineperiodFieldNumber = 162;
  ...
  static const int kTschchartseriesdefaulttrendlineshowlabelFieldNumber = 163;
  ...
  static const int kTschchartseriesdefaulttrendlinelabelstringFieldNumber = 164;
  ...
  static const int kTschchartseriesdefaulttrendlineshowequationFieldNumber = 165;
  ...
  static const int kTschchartseriesdefaulttrendlineshowr2ValueFieldNumber = 166;
  ...
  static const int kTschchartseriesdefaulterrorbarsettingFieldNumber = 170;
  ...
  static const int kTschchartseriesdefaulterrorbarsettingscatterxFieldNumber = 171;
  ...
  static const int kTschchartseriesdefaulterrorbartypeFieldNumber = 172;
  ...
  static const int kTschchartseriesdefaulterrorbartypescatterxFieldNumber = 173;
  ...
  static const int kTschchartseriesdefaulterrorbarfixedvalueFieldNumber = 174;
  ...
  static const int kTschchartseriesdefaulterrorbarfixedvaluescatterxFieldNumber = 175;
  ...
  static const int kTschchartseriesdefaulterrorbarpercentvalueFieldNumber = 176;
  ...
  static const int kTschchartseriesdefaulterrorbarpercentvaluescatterxFieldNumber = 177;
  ...
  static const int kTschchartseriesdefaulterrorbarstddevvalueFieldNumber = 178;
  ...
  static const int kTschchartseriesdefaulterrorbarstddevvaluescatterxFieldNumber = 179;
  ...
  static const int kTschchartseriesdefaulterrorbarcustompositivedataFieldNumber = 190;
  ...
  static const int kTschchartseriesdefaulterrorbarcustompositivedatascatterxFieldNumber = 191;
  ...
  static const int kTschchartseriesdefaulterrorbarcustomnegativedataFieldNumber = 192;
  ...
  static const int kTschchartseriesdefaulterrorbarcustomnegativedatascatterxFieldNumber = 193;
  ...
  static const int kTschchartseriesdefaulttrendlineequationoffsetxFieldNumber = 194;
  ...
  static const int kTschchartseriesdefaulttrendlineequationoffsetyFieldNumber = 195;
  ...
  static const int kTschchartseriesdefaulttrendlinersquaredoffsetxFieldNumber = 196;
  ...
  static const int kTschchartseriesdefaulttrendlinersquaredoffsetyFieldNumber = 197;
  ...
  static const int kTschchartseriesdefaultshowtrendlineFieldNumber = 198;
  ...
  static const int kTschchartseriesdefaultshowerrorbarFieldNumber = 199;
  ...
  static const int kTschchartseriesdefaultshowerrorbarscatterxFieldNumber = 200;
  ...
  static const int kTschchartseriesbubblesizedimensionFieldNumber = 208;
  ...
  static const int kTschchartseriesbubbleshowvaluelabelsFieldNumber = 209;
  ...
  static const int kTschchartseriesbubblelinetypeFieldNumber = 210;
  ...
  static const int kTschchartseriesbubbleshownegativedataFieldNumber = 216;
  ...
  static const int kTschchartseriesbubbleadjustmentscaleFieldNumber = 217;
...
inline void ChartInfoArchive::set_has_super() {
  _has_bits_[0] |= 0x00000001u;
}
inline void ChartInfoArchive::clear_has_super() {
  _has_bits_[0] &= ~0x00000001u;
}
inline void ChartInfoArchive::clear_super() {
...
inline void ChartInfoArchive::set_has_style() {
  _has_bits_[0] |= 0x00000004u;
}
inline void ChartInfoArchive::clear_has_style() {
  _has_bits_[0] &= ~0x00000004u;
}
inline void ChartInfoArchive::clear_style() {
...
inline void ChartInfoArchive::set_has_chart_type() {
  _has_bits_[0] |= 0x00000008u;
}
inline void ChartInfoArchive::clear_has_chart_type() {
  _has_bits_[0] &= ~0x00000008u;
}
...
inline void ChartInfoArchive::set_has_legend_model() {
  _has_bits_[0] |= 0x00000010u;
}
inline void ChartInfoArchive::clear_has_legend_model() {
  _has_bits_[0] &= ~0x00000010u;
}
inline void ChartInfoArchive::clear_legend_model() {
  if (legend_model_ != NULL) legend_model_->::TSCH::PreUFF::LegendModelArchive::Clear();
  clear_has_legend_model();
}
inline const ::TSCH::PreUFF::LegendModelArchive& ChartInfoArchive::legend_model() const {
  return legend_model_ != NULL ? *legend_model_ : *default_instance_->legend_model_;
}
inline ::TSCH::PreUFF::LegendModelArchive* ChartInfoArchive::mutable_legend_model() {
  set_has_legend_model();
  if (legend_model_ == NULL) legend_model_ = new ::TSCH::PreUFF::LegendModelArchive;
...
inline void ChartInfoArchive::set_has_inner_chart_frame() {
  _has_bits_[0] |= 0x00000020u;
}
inline void ChartInfoArchive::clear_has_inner_chart_frame() {
  _has_bits_[0] &= ~0x00000020u;
}
inline void ChartInfoArchive::clear_inner_chart_frame() {
  if (inner_chart_frame_ != NULL) inner_chart_frame_->::TSCH::RectArchive::Clear();
  clear_has_inner_chart_frame();
}
inline const ::TSCH::RectArchive& ChartInfoArchive::inner_chart_frame() const {
  return inner_chart_frame_ != NULL ? *inner_chart_frame_ : *default_instance_->inner_chart_frame_;
}
inline ::TSCH::RectArchive* ChartInfoArchive::mutable_inner_chart_frame() {
  set_has_inner_chart_frame();
  if (inner_chart_frame_ == NULL) inner_chart_frame_ = new ::TSCH::RectArchive;
...
inline void ChartInfoArchive::clear_value_axis_styles() {
...
inline void ChartInfoArchive::clear_category_axis_styles() {
...
inline void ChartInfoArchive::clear_value_axis_nonstyles() {
...
inline void ChartInfoArchive::clear_category_axis_nonstyles() {
...
inline void ChartInfoArchive::clear_series_theme_styles() {
...
inline void ChartInfoArchive::set_has_series_private_styles() {
  _has_bits_[0] |= 0x00000800u;
}
inline void ChartInfoArchive::clear_has_series_private_styles() {
  _has_bits_[0] &= ~0x00000800u;
}
inline void ChartInfoArchive::clear_series_private_styles() {
...
inline const ::TSCH::SparseReferenceArrayArchive& ChartInfoArchive::series_private_styles() const {
  return series_private_styles_ != NULL ? *series_private_styles_ : *default_instance_->series_private_styles_;
}
inline ::TSCH::SparseReferenceArrayArchive* ChartInfoArchive::mutable_series_private_styles() {
...
inline ::TSCH::SparseReferenceArrayArchive* ChartInfoArchive::release_series_private_styles() {
  clear_has_series_private_styles();
  ::TSCH::SparseReferenceArrayArchive* temp = series_private_styles_;
  series_private_styles_ = NULL;
  return temp;
}
inline void ChartInfoArchive::set_allocated_series_private_styles(::TSCH::SparseReferenceArrayArchive* series_private_styles) {
...
inline void ChartInfoArchive::set_has_series_non_styles() {
  _has_bits_[0] |= 0x00001000u;
}
inline void ChartInfoArchive::clear_has_series_non_styles() {
  _has_bits_[0] &= ~0x00001000u;
}
inline void ChartInfoArchive::clear_series_non_styles() {
  if (series_non_styles_ != NULL) series_non_styles_->::TSCH::SparseReferenceArrayArchive::Clear();
  clear_has_series_non_styles();
}
inline const ::TSCH::SparseReferenceArrayArchive& ChartInfoArchive::series_non_styles() const {
  return series_non_styles_ != NULL ? *series_non_styles_ : *default_instance_->series_non_styles_;
}
inline ::TSCH::SparseReferenceArrayArchive* ChartInfoArchive::mutable_series_non_styles() {
...
inline ::TSCH::SparseReferenceArrayArchive* ChartInfoArchive::release_series_non_styles() {
  clear_has_series_non_styles();
  ::TSCH::SparseReferenceArrayArchive* temp = series_non_styles_;
  series_non_styles_ = NULL;
  return temp;
}
inline void ChartInfoArchive::set_allocated_series_non_styles(::TSCH::SparseReferenceArrayArchive* series_non_styles) {
...
inline void ChartInfoArchive::set_has_non_style() {
  _has_bits_[0] |= 0x00002000u;
}
inline void ChartInfoArchive::clear_has_non_style() {
  _has_bits_[0] &= ~0x00002000u;
}
inline void ChartInfoArchive::clear_non_style() {
  if (non_style_ != NULL) non_style_->::TSP::Reference::Clear();
  clear_has_non_style();
}
inline const ::TSP::Reference& ChartInfoArchive::non_style() const {
  return non_style_ != NULL ? *non_style_ : *default_instance_->non_style_;
}
inline ::TSP::Reference* ChartInfoArchive::mutable_non_style() {
  set_has_non_style();
  if (non_style_ == NULL) non_style_ = new ::TSP::Reference;
  return non_style_;
}
...
inline void ChartInfoArchive::set_has_mediator() {
  _has_bits_[0] |= 0x00004000u;
}
inline void ChartInfoArchive::clear_has_mediator() {
  _has_bits_[0] &= ~0x00004000u;
}
inline void ChartInfoArchive::clear_mediator() {
...
inline void ChartInfoArchive::set_has_cde_preview_origin() {
  _has_bits_[0] |= 0x00008000u;
}
inline void ChartInfoArchive::clear_has_cde_preview_origin() {
  _has_bits_[0] &= ~0x00008000u;
}
inline void ChartInfoArchive::clear_cde_preview_origin() {
  if (cde_preview_origin_ != NULL) cde_preview_origin_->::TSP::Point::Clear();
  clear_has_cde_preview_origin();
}
inline const ::TSP::Point& ChartInfoArchive::cde_preview_origin() const {
  return cde_preview_origin_ != NULL ? *cde_preview_origin_ : *default_instance_->cde_preview_origin_;
}
inline ::TSP::Point* ChartInfoArchive::mutable_cde_preview_origin() {
  set_has_cde_preview_origin();
  if (cde_preview_origin_ == NULL) cde_preview_origin_ = new ::TSP::Point;
...
inline void ChartInfoArchive::set_has_chart_style_preset() {
  _has_bits_[0] |= 0x00010000u;
}
inline void ChartInfoArchive::clear_has_chart_style_preset() {
  _has_bits_[0] &= ~0x00010000u;
}
inline void ChartInfoArchive::clear_chart_style_preset() {
  if (chart_style_preset_ != NULL) chart_style_preset_->::TSP::Reference::Clear();
  clear_has_chart_style_preset();
}
inline const ::TSP::Reference& ChartInfoArchive::chart_style_preset() const {
  return chart_style_preset_ != NULL ? *chart_style_preset_ : *default_instance_->chart_style_preset_;
}
inline ::TSP::Reference* ChartInfoArchive::mutable_chart_style_preset() {
  set_has_chart_style_preset();
  if (chart_style_preset_ == NULL) chart_style_preset_ = new ::TSP::Reference;
...
inline void ChartInfoArchive::clear_paragraph_styles() {
...
inline void ChartInfoArchive::set_has_last_row_sected_in_the_cde() {
  _has_bits_[0] |= 0x00040000u;
}
inline void ChartInfoArchive::clear_has_last_row_sected_in_the_cde() {
  _has_bits_[0] &= ~0x00040000u;
}
inline void ChartInfoArchive::clear_last_row_sected_in_the_cde() {
  last_row_sected_in_the_cde_ = 0;
  clear_has_last_row_sected_in_the_cde();
}
inline ::google::protobuf::int32 ChartInfoArchive::last_row_sected_in_the_cde() const {
  return last_row_sected_in_the_cde_;
}
inline void ChartInfoArchive::set_last_row_sected_in_the_cde(::google::protobuf::int32 value) {
...
inline void ChartInfoArchive::set_has_last_column_sected_in_the_cde() {
  _has_bits_[0] |= 0x00080000u;
}
inline void ChartInfoArchive::clear_has_last_column_sected_in_the_cde() {
  _has_bits_[0] &= ~0x00080000u;
}
inline void ChartInfoArchive::clear_last_column_sected_in_the_cde() {
  last_column_sected_in_the_cde_ = 0;
  clear_has_last_column_sected_in_the_cde();
}
inline ::google::protobuf::int32 ChartInfoArchive::last_column_sected_in_the_cde() const {
  return last_column_sected_in_the_cde_;
}
inline void ChartInfoArchive::set_last_column_sected_in_the_cde(::google::protobuf::int32 value) {
...
inline void ChartInfoArchive::set_has_chart_style_preset_index() {
  _has_bits_[0] |= 0x00100000u;
}
inline void ChartInfoArchive::clear_has_chart_style_preset_index() {
  _has_bits_[0] &= ~0x00100000u;
}
inline void ChartInfoArchive::clear_chart_style_preset_index() {
  chart_style_preset_index_ = 0;
  clear_has_chart_style_preset_index();
}
inline ::google::protobuf::int32 ChartInfoArchive::chart_style_preset_index() const {
  return chart_style_preset_index_;
}
inline void ChartInfoArchive::set_chart_style_preset_index(::google::protobuf::int32 value) {
...
inline void ChartInfoArchive::set_has_needs_calc_engine_deferred_import_action() {
  _has_bits_[0] |= 0x00200000u;
}
inline void ChartInfoArchive::clear_has_needs_calc_engine_deferred_import_action() {
  _has_bits_[0] &= ~0x00200000u;
}
...
inline void LegendModelArchive::set_has_info() {
  _has_bits_[0] |= 0x00000001u;
}
inline void LegendModelArchive::clear_has_info() {
  _has_bits_[0] &= ~0x00000001u;
}
inline void LegendModelArchive::clear_info() {
...
inline void LegendModelArchive::set_has_frame() {
  _has_bits_[0] |= 0x00000002u;
}
inline void LegendModelArchive::clear_has_frame() {
  _has_bits_[0] &= ~0x00000002u;
}
inline void LegendModelArchive::clear_frame() {
...
inline ::TSCH::RectArchive* LegendModelArchive::mutable_frame() {
  set_has_frame();
  if (frame_ == NULL) frame_ = new ::TSCH::RectArchive;
  return frame_;
}
...
inline void LegendModelArchive::set_has_style() {
  _has_bits_[0] |= 0x00000004u;
}
inline void LegendModelArchive::clear_has_style() {
  _has_bits_[0] &= ~0x00000004u;
}
inline void LegendModelArchive::clear_style() {
  if (style_ != NULL) style_->::TSP::Reference::Clear();
  clear_has_style();
}
...
inline void LegendModelArchive::set_has_non_style() {
  _has_bits_[0] |= 0x00000008u;
}
inline void LegendModelArchive::clear_has_non_style() {
  _has_bits_[0] &= ~0x00000008u;
}
inline void LegendModelArchive::clear_non_style() {
  if (non_style_ != NULL) non_style_->::TSP::Reference::Clear();
  clear_has_non_style();
}
...
inline void ChartModelArchive::set_has_info() {
  _has_bits_[0] |= 0x00000001u;
}
inline void ChartModelArchive::clear_has_info() {
  _has_bits_[0] &= ~0x00000001u;
}
inline void ChartModelArchive::clear_info() {
  if (info_ != NULL) info_->::TSP::Reference::Clear();
  clear_has_info();
}
...
inline void ChartModelArchive::set_has_grid() {
  _has_bits_[0] |= 0x00000002u;
}
inline void ChartModelArchive::clear_has_grid() {
  _has_bits_[0] &= ~0x00000002u;
}
inline void ChartModelArchive::clear_grid() {
...
inline ::TSP::Reference* ChartModelArchive::mutable_grid() {
  set_has_grid();
  if (grid_ == NULL) grid_ = new ::TSP::Reference;
  return grid_;
}
...
inline ::google::protobuf::uint32 ChartModelArchive::series_types(int index) const {
  return series_types_.Get(index);
}
inline void ChartModelArchive::set_series_types(int index, ::google::protobuf::uint32 value) {
  series_types_.Set(index, value);
}
inline void ChartModelArchive::add_series_types(::google::protobuf::uint32 value) {
...
inline void ChartModelArchive::set_has_scatter_format() {
  _has_bits_[0] |= 0x00000008u;
}
inline void ChartModelArchive::clear_has_scatter_format() {
  _has_bits_[0] &= ~0x00000008u;
}
...
inline ::google::protobuf::uint32 ChartModelArchive::scatter_format() const {
  return scatter_format_;
}
inline void ChartModelArchive::set_scatter_format(::google::protobuf::uint32 value) {
...
inline void ChartModelArchive::set_has_multidataset_index() {
  _has_bits_[0] |= 0x00000020u;
}
inline void ChartModelArchive::clear_has_multidataset_index() {
  _has_bits_[0] &= ~0x00000020u;
}
...
inline ::google::protobuf::uint32 ChartModelArchive::multidataset_index() const {
  return multidataset_index_;
}
inline void ChartModelArchive::set_multidataset_index(::google::protobuf::uint32 value) {
...
inline void ChartGridArchive::set_has_direction() {
  _has_bits_[0] |= 0x00000001u;
}
inline void ChartGridArchive::clear_has_direction() {
  _has_bits_[0] &= ~0x00000001u;
}
...
inline ::google::protobuf::int32 ChartGridArchive::direction() const {
  return direction_;
}
inline void ChartGridArchive::set_direction(::google::protobuf::int32 value) {
  set_has_direction();
  direction_ = value;
}
...
inline void ChartGridArchive::set_has_dirty() {
  _has_bits_[0] |= 0x00000010u;
}
inline void ChartGridArchive::clear_has_dirty() {
  _has_bits_[0] &= ~0x00000010u;
}
...
inline void ChartsNumberFormatArchive::set_has_value_type() {
  _has_bits_[0] |= 0x00000001u;
}
inline void ChartsNumberFormatArchive::clear_has_value_type() {
  _has_bits_[0] &= ~0x00000001u;
}
...
inline void ChartsNumberFormatArchive::set_has_format_string() {
  _has_bits_[0] |= 0x00000002u;
}
inline void ChartsNumberFormatArchive::clear_has_format_string() {
  _has_bits_[0] &= ~0x00000002u;
}
inline void ChartsNumberFormatArchive::clear_format_string() {
  ...
  clear_has_format_string();
}
inline const ::std::string& ChartsNumberFormatArchive::format_string() const {
  return *format_string_;
}
inline void ChartsNumberFormatArchive::set_format_string(const ::std::string& value) {
  set_has_format_string();
  if (format_string_ == &::google::protobuf::internal::kEmptyString) {
    format_string_ = new ::std::string;
  }
  format_string_->assign(value);
}
inline void ChartsNumberFormatArchive::set_format_string(const char* value) {
  set_has_format_string();
  if (format_string_ == &::google::protobuf::internal::kEmptyString) {
    format_string_ = new ::std::string;
  }
...
inline void ChartsNumberFormatArchive::set_format_string(const char* value, size_t size) {
  set_has_format_string();
  if (format_string_ == &::google::protobuf::internal::kEmptyString) {
    format_string_ = new ::std::string;
  }
  format_string_->assign(reinterpret_cast<const char*>(value), size);
}
...
inline ::std::string* ChartsNumberFormatArchive::release_format_string() {
  ...
  if (format_string_ == &::google::protobuf::internal::kEmptyString) {
    ...
    ::std::string* temp = format_string_;
...
inline void ChartsNumberFormatArchive::set_has_decimal_places() {
  _has_bits_[0] |= 0x00000004u;
}
inline void ChartsNumberFormatArchive::clear_has_decimal_places() {
  _has_bits_[0] &= ~0x00000004u;
}
...
inline ::google::protobuf::uint32 ChartsNumberFormatArchive::decimal_places() const {
  return decimal_places_;
}
inline void ChartsNumberFormatArchive::set_decimal_places(::google::protobuf::uint32 value) {
...
inline void ChartsNumberFormatArchive::set_has_currency_code() {
  _has_bits_[0] |= 0x00000008u;
}
inline void ChartsNumberFormatArchive::clear_has_currency_code() {
  _has_bits_[0] &= ~0x00000008u;
}
...
inline void ChartsNumberFormatArchive::set_currency_code(const ::std::string& value) {
...
inline void ChartsNumberFormatArchive::set_currency_code(const char* value) {
  set_has_currency_code();
  if (currency_code_ == &::google::protobuf::internal::kEmptyString) {
    currency_code_ = new ::std::string;
  }
...
inline void ChartsNumberFormatArchive::set_currency_code(const char* value, size_t size) {
  set_has_currency_code();
  if (currency_code_ == &::google::protobuf::internal::kEmptyString) {
    currency_code_ = new ::std::string;
  }
...
inline void ChartsNumberFormatArchive::set_has_negative_style() {
  _has_bits_[0] |= 0x00000010u;
}
inline void ChartsNumberFormatArchive::clear_has_negative_style() {
  _has_bits_[0] &= ~0x00000010u;
}
...
inline void ChartsNumberFormatArchive::set_has_show_thousands_separator() {
  _has_bits_[0] |= 0x00000020u;
}
inline void ChartsNumberFormatArchive::clear_has_show_thousands_separator() {
  _has_bits_[0] &= ~0x00000020u;
}
...
inline void ChartsNumberFormatArchive::set_has_fraction_accuracy() {
  _has_bits_[0] |= 0x00000040u;
}
inline void ChartsNumberFormatArchive::clear_has_fraction_accuracy() {
  _has_bits_[0] &= ~0x00000040u;
}
...
inline void ChartsNumberFormatArchive::set_has_suffix_string() {
  _has_bits_[0] |= 0x00000080u;
}
inline void ChartsNumberFormatArchive::clear_has_suffix_string() {
  _has_bits_[0] &= ~0x00000080u;
}
inline void ChartsNumberFormatArchive::clear_suffix_string() {
  ...
  clear_has_suffix_string();
}
inline const ::std::string& ChartsNumberFormatArchive::suffix_string() const {
  return *suffix_string_;
}
inline void ChartsNumberFormatArchive::set_suffix_string(const ::std::string& value) {
  set_has_suffix_string();
  if (suffix_string_ == &::google::protobuf::internal::kEmptyString) {
    suffix_string_ = new ::std::string;
  }
  suffix_string_->assign(value);
}
inline void ChartsNumberFormatArchive::set_suffix_string(const char* value) {
  set_has_suffix_string();
  if (suffix_string_ == &::google::protobuf::internal::kEmptyString) {
    suffix_string_ = new ::std::string;
  }
...
inline void ChartsNumberFormatArchive::set_suffix_string(const char* value, size_t size) {
  set_has_suffix_string();
  if (suffix_string_ == &::google::protobuf::internal::kEmptyString) {
    suffix_string_ = new ::std::string;
  }
  suffix_string_->assign(reinterpret_cast<const char*>(value), size);
}
...
inline ::std::string* ChartsNumberFormatArchive::release_suffix_string() {
  ...
  if (suffix_string_ == &::google::protobuf::internal::kEmptyString) {
    ...
    ::std::string* temp = suffix_string_;
...
inline void ChartsNumberFormatArchive::set_has_base() {
  _has_bits_[0] |= 0x00000100u;
}
inline void ChartsNumberFormatArchive::clear_has_base() {
  _has_bits_[0] &= ~0x00000100u;
}
...
inline ::google::protobuf::uint32 ChartsNumberFormatArchive::base() const {
  return base_;
}
inline void ChartsNumberFormatArchive::set_base(::google::protobuf::uint32 value) {
  set_has_base();
  base_ = value;
}
...
inline void ChartsNumberFormatArchive::set_has_base_places() {
  _has_bits_[0] |= 0x00000200u;
}
inline void ChartsNumberFormatArchive::clear_has_base_places() {
  _has_bits_[0] &= ~0x00000200u;
}
...
inline ::google::protobuf::uint32 ChartsNumberFormatArchive::base_places() const {
  return base_places_;
}
inline void ChartsNumberFormatArchive::set_base_places(::google::protobuf::uint32 value) {
  set_has_base_places();
  base_places_ = value;
}
...
inline void ChartsNumberFormatArchive::set_has_base_use_minus_sign() {
  _has_bits_[0] |= 0x00000400u;
}
inline void ChartsNumberFormatArchive::clear_has_base_use_minus_sign() {
  _has_bits_[0] &= ~0x00000400u;
}
...
inline void ChartsNumberFormatArchive::set_has_use_accounting_style() {
  _has_bits_[0] |= 0x00000800u;
}
inline void ChartsNumberFormatArchive::clear_has_use_accounting_style() {
  _has_bits_[0] &= ~0x00000800u;
}
...
inline void ChartsNumberFormatArchive::set_has_is_custom() {
  _has_bits_[0] |= 0x00001000u;
}
inline void ChartsNumberFormatArchive::clear_has_is_custom() {
  _has_bits_[0] &= ~0x00001000u;
}
...
inline void ChartsNumberFormatArchive::set_has_scale_factor() {
  _has_bits_[0] |= 0x00002000u;
}
inline void ChartsNumberFormatArchive::clear_has_scale_factor() {
  _has_bits_[0] &= ~0x00002000u;
}
...
inline void ChartsNumberFormatArchive::set_has_interstitial_string_insertion_indexes() {
  _has_bits_[0] |= 0x00008000u;
}
inline void ChartsNumberFormatArchive::clear_has_interstitial_string_insertion_indexes() {
  _has_bits_[0] &= ~0x00008000u;
}
inline void ChartsNumberFormatArchive::clear_interstitial_string_insertion_indexes() {
  if (interstitial_string_insertion_indexes_ != NULL) interstitial_string_insertion_indexes_->::TSP::IndexSet::Clear();
  clear_has_interstitial_string_insertion_indexes();
}
inline const ::TSP::IndexSet& ChartsNumberFormatArchive::interstitial_string_insertion_indexes() const {
  return interstitial_string_insertion_indexes_ != NULL ? *interstitial_string_insertion_indexes_ : *default_instance_->interstitial_string_insertion_indexes_;
}
inline ::TSP::IndexSet* ChartsNumberFormatArchive::mutable_interstitial_string_insertion_indexes() {
  set_has_interstitial_string_insertion_indexes();
  if (interstitial_string_insertion_indexes_ == NULL) interstitial_string_insertion_indexes_ = new ::TSP::IndexSet;
...
inline void ChartsNumberFormatArchive::set_has_index_from_right_of_last_digit_placeholder() {
  _has_bits_[0] |= 0x00010000u;
}
inline void ChartsNumberFormatArchive::clear_has_index_from_right_of_last_digit_placeholder() {
  _has_bits_[0] &= ~0x00010000u;
}
inline void ChartsNumberFormatArchive::clear_index_from_right_of_last_digit_placeholder() {
  ...
  clear_has_index_from_right_of_last_digit_placeholder();
}
inline ::google::protobuf::uint32 ChartsNumberFormatArchive::index_from_right_of_last_digit_placeholder() const {
  return index_from_right_of_last_digit_placeholder_;
}
inline void ChartsNumberFormatArchive::set_index_from_right_of_last_digit_placeholder(::google::protobuf::uint32 value) {
...
inline void ChartsNumberFormatArchive::set_has_is_text_format() {
  _has_bits_[0] |= 0x00020000u;
}
inline void ChartsNumberFormatArchive::clear_has_is_text_format() {
  _has_bits_[0] &= ~0x00020000u;
}
inline void ChartsNumberFormatArchive::clear_is_text_format() {
  is_text_format_ = false;
  clear_has_is_text_format();
}
...
inline void ChartsNumberFormatArchive::set_has_minimum_integer_width() {
  _has_bits_[0] |= 0x00040000u;
}
inline void ChartsNumberFormatArchive::clear_has_minimum_integer_width() {
  _has_bits_[0] &= ~0x00040000u;
}
inline void ChartsNumberFormatArchive::clear_minimum_integer_width() {
  minimum_integer_width_ = 0u;
  clear_has_minimum_integer_width();
}
inline ::google::protobuf::uint32 ChartsNumberFormatArchive::minimum_integer_width() const {
  return minimum_integer_width_;
}
inline void ChartsNumberFormatArchive::set_minimum_integer_width(::google::protobuf::uint32 value) {
...
inline void ChartsNumberFormatArchive::set_has_decimal_width() {
  _has_bits_[0] |= 0x00080000u;
}
inline void ChartsNumberFormatArchive::clear_has_decimal_width() {
  _has_bits_[0] &= ~0x00080000u;
}
...
inline ::google::protobuf::uint32 ChartsNumberFormatArchive::decimal_width() const {
  return decimal_width_;
}
inline void ChartsNumberFormatArchive::set_decimal_width(::google::protobuf::uint32 value) {
...
inline void ChartsNumberFormatArchive::set_has_number_of_non_space_integer_placeholder_digits() {
  _has_bits_[0] |= 0x00100000u;
}
inline void ChartsNumberFormatArchive::clear_has_number_of_non_space_integer_placeholder_digits() {
  _has_bits_[0] &= ~0x00100000u;
}
inline void ChartsNumberFormatArchive::clear_number_of_non_space_integer_placeholder_digits() {
  ...
  clear_has_number_of_non_space_integer_placeholder_digits();
}
inline ::google::protobuf::uint32 ChartsNumberFormatArchive::number_of_non_space_integer_placeholder_digits() const {
  return number_of_non_space_integer_placeholder_digits_;
}
inline void ChartsNumberFormatArchive::set_number_of_non_space_integer_placeholder_digits(::google::protobuf::uint32 value) {
...
inline void ChartsNumberFormatArchive::set_has_number_of_non_space_decimal_placeholder_digits() {
  _has_bits_[0] |= 0x00200000u;
}
inline void ChartsNumberFormatArchive::clear_has_number_of_non_space_decimal_placeholder_digits() {
  _has_bits_[0] &= ~0x00200000u;
}
inline void ChartsNumberFormatArchive::clear_number_of_non_space_decimal_placeholder_digits() {
  ...
  clear_has_number_of_non_space_decimal_placeholder_digits();
}
inline ::google::protobuf::uint32 ChartsNumberFormatArchive::number_of_non_space_decimal_placeholder_digits() const {
  return number_of_non_space_decimal_placeholder_digits_;
}
inline void ChartsNumberFormatArchive::set_number_of_non_space_decimal_placeholder_digits(::google::protobuf::uint32 value) {
...
inline void ChartsNumberFormatArchive::set_has_format_name() {
  _has_bits_[0] |= 0x00400000u;
}
inline void ChartsNumberFormatArchive::clear_has_format_name() {
  _has_bits_[0] &= ~0x00400000u;
}
inline void ChartsNumberFormatArchive::clear_format_name() {
  ...
  clear_has_format_name();
}
inline const ::std::string& ChartsNumberFormatArchive::format_name() const {
  return *format_name_;
}
inline void ChartsNumberFormatArchive::set_format_name(const ::std::string& value) {
  set_has_format_name();
  if (format_name_ == &::google::protobuf::internal::kEmptyString) {
    format_name_ = new ::std::string;
  }
  format_name_->assign(value);
}
inline void ChartsNumberFormatArchive::set_format_name(const char* value) {
  set_has_format_name();
  if (format_name_ == &::google::protobuf::internal::kEmptyString) {
    format_name_ = new ::std::string;
  }
...
inline void ChartsNumberFormatArchive::set_format_name(const char* value, size_t size) {
  set_has_format_name();
  if (format_name_ == &::google::protobuf::internal::kEmptyString) {
    format_name_ = new ::std::string;
  }
  format_name_->assign(reinterpret_cast<const char*>(value), size);
}
...
inline void ChartsNumberFormatArchive::set_has_prefix_string() {
  _has_bits_[0] |= 0x00800000u;
}
inline void ChartsNumberFormatArchive::clear_has_prefix_string() {
  _has_bits_[0] &= ~0x00800000u;
}
inline void ChartsNumberFormatArchive::clear_prefix_string() {
  ...
  clear_has_prefix_string();
}
inline const ::std::string& ChartsNumberFormatArchive::prefix_string() const {
  return *prefix_string_;
}
inline void ChartsNumberFormatArchive::set_prefix_string(const ::std::string& value) {
  set_has_prefix_string();
  if (prefix_string_ == &::google::protobuf::internal::kEmptyString) {
    prefix_string_ = new ::std::string;
  }
  prefix_string_->assign(value);
}
inline void ChartsNumberFormatArchive::set_prefix_string(const char* value) {
  set_has_prefix_string();
  if (prefix_string_ == &::google::protobuf::internal::kEmptyString) {
    prefix_string_ = new ::std::string;
  }
...
inline void ChartsNumberFormatArchive::set_prefix_string(const char* value, size_t size) {
  set_has_prefix_string();
  if (prefix_string_ == &::google::protobuf::internal::kEmptyString) {
    prefix_string_ = new ::std::string;
  }
  prefix_string_->assign(reinterpret_cast<const char*>(value), size);
}
...
inline ::std::string* ChartsNumberFormatArchive::release_prefix_string() {
  ...
  if (prefix_string_ == &::google::protobuf::internal::kEmptyString) {
    ...
    ::std::string* temp = prefix_string_;
...
// optional string tschchartinfodefaultdeprecatedmasterfontfamily = 24;
inline bool ChartStyleArchive::has_tschchartinfodefaultdeprecatedmasterfontfamily() const {
  return (_has_bits_[0] & 0x00004000u) != 0;
}
inline void ChartStyleArchive::set_has_tschchartinfodefaultdeprecatedmasterfontfamily() {
  _has_bits_[0] |= 0x00004000u;
}
inline void ChartStyleArchive::clear_has_tschchartinfodefaultdeprecatedmasterfontfamily() {
  _has_bits_[0] &= ~0x00004000u;
}
inline void ChartStyleArchive::clear_tschchartinfodefaultdeprecatedmasterfontfamily() {
  ...
  clear_has_tschchartinfodefaultdeprecatedmasterfontfamily();
}
inline const ::std::string& ChartStyleArchive::tschchartinfodefaultdeprecatedmasterfontfamily() const {
  return *tschchartinfodefaultdeprecatedmasterfontfamily_;
}
inline void ChartStyleArchive::set_tschchartinfodefaultdeprecatedmasterfontfamily(const ::std::string& value) {
  set_has_tschchartinfodefaultdeprecatedmasterfontfamily();
  if (tschchartinfodefaultdeprecatedmasterfontfamily_ == &::google::protobuf::internal::kEmptyString) {
    tschchartinfodefaultdeprecatedmasterfontfamily_ = new ::std::string;
  }
  tschchartinfodefaultdeprecatedmasterfontfamily_->assign(value);
}
inline void ChartStyleArchive::set_tschchartinfodefaultdeprecatedmasterfontfamily(const char* value) {
  set_has_tschchartinfodefaultdeprecatedmasterfontfamily();
  if (tschchartinfodefaultdeprecatedmasterfontfamily_ == &::google::protobuf::internal::kEmptyString) {
    tschchartinfodefaultdeprecatedmasterfontfamily_ = new ::std::string;
  }
...
inline void ChartStyleArchive::set_tschchartinfodefaultdeprecatedmasterfontfamily(const char* value, size_t size) {
  set_has_tschchartinfodefaultdeprecatedmasterfontfamily();
  if (tschchartinfodefaultdeprecatedmasterfontfamily_ == &::google::protobuf::internal::kEmptyString) {
    tschchartinfodefaultdeprecatedmasterfontfamily_ = new ::std::string;
  }
  tschchartinfodefaultdeprecatedmasterfontfamily_->assign(reinterpret_cast<const char*>(value), size);
}
inline ::std::string* ChartStyleArchive::mutable_tschchartinfodefaultdeprecatedmasterfontfamily() {
  set_has_tschchartinfodefaultdeprecatedmasterfontfamily();
  if (tschchartinfodefaultdeprecatedmasterfontfamily_ == &::google::protobuf::internal::kEmptyString) {
    tschchartinfodefaultdeprecatedmasterfontfamily_ = new ::std::string;
  }
...
inline ::std::string* ChartStyleArchive::release_tschchartinfodefaultdeprecatedmasterfontfamily() {
  clear_has_tschchartinfodefaultdeprecatedmasterfontfamily();
  if (tschchartinfodefaultdeprecatedmasterfontfamily_ == &::google::protobuf::internal::kEmptyString) {
    return NULL;
  } else {
    ::std::string* temp = tschchartinfodefaultdeprecatedmasterfontfamily_;
    tschchartinfodefaultdeprecatedmasterfontfamily_ = const_cast< ::std::string*>(&::google::protobuf::internal::kEmptyString);
    return temp;
  }
}
inline void ChartStyleArchive::set_allocated_tschchartinfodefaultdeprecatedmasterfontfamily(::std::string* tschchartinfodefaultdeprecatedmasterfontfamily) {
  if (tschchartinfodefaultdeprecatedmasterfontfamily_ != &::google::protobuf::internal::kEmptyString) {
    delete tschchartinfodefaultdeprecatedmasterfontfamily_;
  }
  if (tschchartinfodefaultdeprecatedmasterfontfamily) {
    set_has_tschchartinfodefaultdeprecatedmasterfontfamily();
    tschchartinfodefaultdeprecatedmasterfontfamily_ = tschchartinfodefaultdeprecatedmasterfontfamily;
  } else {
    clear_has_tschchartinfodefaultdeprecatedmasterfontfamily();
    tschchartinfodefaultdeprecatedmasterfontfamily_ = const_cast< ::std::string*>(&::google::protobuf::internal::kEmptyString);
  }
...
// optional int32 tschchartinfodefaultdeprecatedmasterfontnamedsize = 25;
inline bool ChartStyleArchive::has_tschchartinfodefaultdeprecatedmasterfontnamedsize() const {
  return (_has_bits_[0] & 0x00008000u) != 0;
}
inline void ChartStyleArchive::set_has_tschchartinfodefaultdeprecatedmasterfontnamedsize() {
  _has_bits_[0] |= 0x00008000u;
}
inline void ChartStyleArchive::clear_has_tschchartinfodefaultdeprecatedmasterfontnamedsize() {
  _has_bits_[0] &= ~0x00008000u;
}
inline void ChartStyleArchive::clear_tschchartinfodefaultdeprecatedmasterfontnamedsize() {
  tschchartinfodefaultdeprecatedmasterfontnamedsize_ = 0;
  clear_has_tschchartinfodefaultdeprecatedmasterfontnamedsize();
}
inline ::google::protobuf::int32 ChartStyleArchive::tschchartinfodefaultdeprecatedmasterfontnamedsize() const {
  return tschchartinfodefaultdeprecatedmasterfontnamedsize_;
}
inline void ChartStyleArchive::set_tschchartinfodefaultdeprecatedmasterfontnamedsize(::google::protobuf::int32 value) {
...
inline void ChartStyleArchive::set_has_tschchartinfodefaultdeprecatedtrendlineequationparagraphstyleindex() {
  _has_bits_[0] |= 0x00010000u;
}
inline void ChartStyleArchive::clear_has_tschchartinfodefaultdeprecatedtrendlineequationparagraphstyleindex() {
  _has_bits_[0] &= ~0x00010000u;
}
inline void ChartStyleArchive::clear_tschchartinfodefaultdeprecatedtrendlineequationparagraphstyleindex() {
  ...
  clear_has_tschchartinfodefaultdeprecatedtrendlineequationparagraphstyleindex();
}
inline ::google::protobuf::int32 ChartStyleArchive::tschchartinfodefaultdeprecatedtrendlineequationparagraphstyleindex() const {
  return tschchartinfodefaultdeprecatedtrendlineequationparagraphstyleindex_;
}
inline void ChartStyleArchive::set_tschchartinfodefaultdeprecatedtrendlineequationparagraphstyleindex(::google::protobuf::int32 value) {
...
inline void ChartStyleArchive::set_has_tschchartinfodefaultdeprecatedtrendlinersquaredparagraphstyleindex() {
  _has_bits_[0] |= 0x00020000u;
}
inline void ChartStyleArchive::clear_has_tschchartinfodefaultdeprecatedtrendlinersquaredparagraphstyleindex() {
  _has_bits_[0] &= ~0x00020000u;
}
inline void ChartStyleArchive::clear_tschchartinfodefaultdeprecatedtrendlinersquaredparagraphstyleindex() {
  ...
  clear_has_tschchartinfodefaultdeprecatedtrendlinersquaredparagraphstyleindex();
}
inline ::google::protobuf::int32 ChartStyleArchive::tschchartinfodefaultdeprecatedtrendlinersquaredparagraphstyleindex() const {
  return tschchartinfodefaultdeprecatedtrendlinersquaredparagraphstyleindex_;
}
inline void ChartStyleArchive::set_tschchartinfodefaultdeprecatedtrendlinersquaredparagraphstyleindex(::google::protobuf::int32 value) {
...
inline void ChartStyleArchive::set_has_tschchartinfodefaultdeprecatedtrendlineequationshadow() {
  _has_bits_[0] |= 0x00040000u;
}
inline void ChartStyleArchive::clear_has_tschchartinfodefaultdeprecatedtrendlineequationshadow() {
  _has_bits_[0] &= ~0x00040000u;
}
inline void ChartStyleArchive::clear_tschchartinfodefaultdeprecatedtrendlineequationshadow() {
  ...
  clear_has_tschchartinfodefaultdeprecatedtrendlineequationshadow();
}
inline const ::TSD::ShadowArchive& ChartStyleArchive::tschchartinfodefaultdeprecatedtrendlineequationshadow() const {
  return tschchartinfodefaultdeprecatedtrendlineequationshadow_ != NULL ? *tschchartinfodefaultdeprecatedtrendlineequationshadow_ : *default_instance_->tschchartinfodefaultdeprecatedtrendlineequationshadow_;
}
inline ::TSD::ShadowArchive* ChartStyleArchive::mutable_tschchartinfodefaultdeprecatedtrendlineequationshadow() {
  set_has_tschchartinfodefaultdeprecatedtrendlineequationshadow();
  if (tschchartinfodefaultdeprecatedtrendlineequationshadow_ == NULL) tschchartinfodefaultdeprecatedtrendlineequationshadow_ = new ::TSD::ShadowArchive;
...
inline void ChartStyleArchive::set_has_tschchartinfodefaultdeprecatedtrendlinersquaredshadow() {
  _has_bits_[0] |= 0x00080000u;
}
inline void ChartStyleArchive::clear_has_tschchartinfodefaultdeprecatedtrendlinersquaredshadow() {
  _has_bits_[0] &= ~0x00080000u;
}
inline void ChartStyleArchive::clear_tschchartinfodefaultdeprecatedtrendlinersquaredshadow() {
  ...
  clear_has_tschchartinfodefaultdeprecatedtrendlinersquaredshadow();
}
inline const ::TSD::ShadowArchive& ChartStyleArchive::tschchartinfodefaultdeprecatedtrendlinersquaredshadow() const {
  return tschchartinfodefaultdeprecatedtrendlinersquaredshadow_ != NULL ? *tschchartinfodefaultdeprecatedtrendlinersquaredshadow_ : *default_instance_->tschchartinfodefaultdeprecatedtrendlinersquaredshadow_;
}
inline ::TSD::ShadowArchive* ChartStyleArchive::mutable_tschchartinfodefaultdeprecatedtrendlinersquaredshadow() {
  set_has_tschchartinfodefaultdeprecatedtrendlinersquaredshadow();
  if (tschchartinfodefaultdeprecatedtrendlinersquaredshadow_ == NULL) tschchartinfodefaultdeprecatedtrendlinersquaredshadow_ = new ::TSD::ShadowArchive;
...
inline void ChartStyleArchive::set_has_tschchartinfodefaultdeprecatedtrendlineequationopacity() {
  _has_bits_[0] |= 0x00100000u;
}
inline void ChartStyleArchive::clear_has_tschchartinfodefaultdeprecatedtrendlineequationopacity() {
  _has_bits_[0] &= ~0x00100000u;
}
inline void ChartStyleArchive::clear_tschchartinfodefaultdeprecatedtrendlineequationopacity() {
  ...
  clear_has_tschchartinfodefaultdeprecatedtrendlineequationopacity();
}
...
inline void ChartStyleArchive::set_has_tschchartinfodefaultdeprecatedtrendlinersquaredopacity() {
  _has_bits_[0] |= 0x00200000u;
}
inline void ChartStyleArchive::clear_has_tschchartinfodefaultdeprecatedtrendlinersquaredopacity() {
  _has_bits_[0] &= ~0x00200000u;
}
inline void ChartStyleArchive::clear_tschchartinfodefaultdeprecatedtrendlinersquaredopacity() {
  ...
  clear_has_tschchartinfodefaultdeprecatedtrendlinersquaredopacity();
}
...
inline void ChartStyleArchive::set_has_tschchartinfobardeprecated3dshadow() {
  _has_bits_[0] |= 0x00400000u;
}
inline void ChartStyleArchive::clear_has_tschchartinfobardeprecated3dshadow() {
  _has_bits_[0] &= ~0x00400000u;
}
inline void ChartStyleArchive::clear_tschchartinfobardeprecated3dshadow() {
  if (tschchartinfobardeprecated3dshadow_ != NULL) tschchartinfobardeprecated3dshadow_->::TSD::ShadowArchive::Clear();
  clear_has_tschchartinfobardeprecated3dshadow();
}
inline const ::TSD::ShadowArchive& ChartStyleArchive::tschchartinfobardeprecated3dshadow() const {
  return tschchartinfobardeprecated3dshadow_ != NULL ? *tschchartinfobardeprecated3dshadow_ : *default_instance_->tschchartinfobardeprecated3dshadow_;
}
inline ::TSD::ShadowArchive* ChartStyleArchive::mutable_tschchartinfobardeprecated3dshadow() {
  set_has_tschchartinfobardeprecated3dshadow();
  if (tschchartinfobardeprecated3dshadow_ == NULL) tschchartinfobardeprecated3dshadow_ = new ::TSD::ShadowArchive;
...
inline void ChartStyleArchive::set_has_tschchartinfocolumndeprecated3dshadow() {
  _has_bits_[0] |= 0x00800000u;
}
inline void ChartStyleArchive::clear_has_tschchartinfocolumndeprecated3dshadow() {
  _has_bits_[0] &= ~0x00800000u;
}
inline void ChartStyleArchive::clear_tschchartinfocolumndeprecated3dshadow() {
  if (tschchartinfocolumndeprecated3dshadow_ != NULL) tschchartinfocolumndeprecated3dshadow_->::TSD::ShadowArchive::Clear();
  clear_has_tschchartinfocolumndeprecated3dshadow();
}
inline const ::TSD::ShadowArchive& ChartStyleArchive::tschchartinfocolumndeprecated3dshadow() const {
  return tschchartinfocolumndeprecated3dshadow_ != NULL ? *tschchartinfocolumndeprecated3dshadow_ : *default_instance_->tschchartinfocolumndeprecated3dshadow_;
}
inline ::TSD::ShadowArchive* ChartStyleArchive::mutable_tschchartinfocolumndeprecated3dshadow() {
  set_has_tschchartinfocolumndeprecated3dshadow();
  if (tschchartinfocolumndeprecated3dshadow_ == NULL) tschchartinfocolumndeprecated3dshadow_ = new ::TSD::ShadowArchive;
...
inline void ChartStyleArchive::set_has_tschchartinfolinedeprecated3dshadow() {
  _has_bits_[0] |= 0x01000000u;
}
inline void ChartStyleArchive::clear_has_tschchartinfolinedeprecated3dshadow() {
  _has_bits_[0] &= ~0x01000000u;
}
inline void ChartStyleArchive::clear_tschchartinfolinedeprecated3dshadow() {
  if (tschchartinfolinedeprecated3dshadow_ != NULL) tschchartinfolinedeprecated3dshadow_->::TSD::ShadowArchive::Clear();
  clear_has_tschchartinfolinedeprecated3dshadow();
}
inline const ::TSD::ShadowArchive& ChartStyleArchive::tschchartinfolinedeprecated3dshadow() const {
  return tschchartinfolinedeprecated3dshadow_ != NULL ? *tschchartinfolinedeprecated3dshadow_ : *default_instance_->tschchartinfolinedeprecated3dshadow_;
}
inline ::TSD::ShadowArchive* ChartStyleArchive::mutable_tschchartinfolinedeprecated3dshadow() {
  set_has_tschchartinfolinedeprecated3dshadow();
  if (tschchartinfolinedeprecated3dshadow_ == NULL) tschchartinfolinedeprecated3dshadow_ = new ::TSD::ShadowArchive;
...
inline void ChartStyleArchive::set_has_tschchartinfoareadeprecated3dshadow() {
  _has_bits_[0] |= 0x02000000u;
}
inline void ChartStyleArchive::clear_has_tschchartinfoareadeprecated3dshadow() {
  _has_bits_[0] &= ~0x02000000u;
}
inline void ChartStyleArchive::clear_tschchartinfoareadeprecated3dshadow() {
  if (tschchartinfoareadeprecated3dshadow_ != NULL) tschchartinfoareadeprecated3dshadow_->::TSD::ShadowArchive::Clear();
  clear_has_tschchartinfoareadeprecated3dshadow();
}
inline const ::TSD::ShadowArchive& ChartStyleArchive::tschchartinfoareadeprecated3dshadow() const {
  return tschchartinfoareadeprecated3dshadow_ != NULL ? *tschchartinfoareadeprecated3dshadow_ : *default_instance_->tschchartinfoareadeprecated3dshadow_;
}
inline ::TSD::ShadowArchive* ChartStyleArchive::mutable_tschchartinfoareadeprecated3dshadow() {
  set_has_tschchartinfoareadeprecated3dshadow();
  if (tschchartinfoareadeprecated3dshadow_ == NULL) tschchartinfoareadeprecated3dshadow_ = new ::TSD::ShadowArchive;
...
inline void ChartStyleArchive::set_has_tschchartinfopiedeprecated3dshadow() {
  _has_bits_[0] |= 0x04000000u;
}
inline void ChartStyleArchive::clear_has_tschchartinfopiedeprecated3dshadow() {
  _has_bits_[0] &= ~0x04000000u;
}
inline void ChartStyleArchive::clear_tschchartinfopiedeprecated3dshadow() {
  if (tschchartinfopiedeprecated3dshadow_ != NULL) tschchartinfopiedeprecated3dshadow_->::TSD::ShadowArchive::Clear();
  clear_has_tschchartinfopiedeprecated3dshadow();
}
inline const ::TSD::ShadowArchive& ChartStyleArchive::tschchartinfopiedeprecated3dshadow() const {
  return tschchartinfopiedeprecated3dshadow_ != NULL ? *tschchartinfopiedeprecated3dshadow_ : *default_instance_->tschchartinfopiedeprecated3dshadow_;
}
inline ::TSD::ShadowArchive* ChartStyleArchive::mutable_tschchartinfopiedeprecated3dshadow() {
  set_has_tschchartinfopiedeprecated3dshadow();
  if (tschchartinfopiedeprecated3dshadow_ == NULL) tschchartinfopiedeprecated3dshadow_ = new ::TSD::ShadowArchive;
...
inline void ChartStyleArchive::set_has_tschchartinfodefaultdeprecated3dbeveledges() {
  _has_bits_[1] |= 0x00000002u;
}
inline void ChartStyleArchive::clear_has_tschchartinfodefaultdeprecated3dbeveledges() {
  _has_bits_[1] &= ~0x00000002u;
}
inline void ChartStyleArchive::clear_tschchartinfodefaultdeprecated3dbeveledges() {
  ...
  clear_has_tschchartinfodefaultdeprecated3dbeveledges();
}
...
inline void ChartStyleArchive::set_has_tschchartinfopiedeprecated3dbeveledges() {
  _has_bits_[1] |= 0x00000004u;
}
inline void ChartStyleArchive::clear_has_tschchartinfopiedeprecated3dbeveledges() {
  _has_bits_[1] &= ~0x00000004u;
}
inline void ChartStyleArchive::clear_tschchartinfopiedeprecated3dbeveledges() {
  tschchartinfopiedeprecated3dbeveledges_ = false;
  clear_has_tschchartinfopiedeprecated3dbeveledges();
}
...
inline void ChartStyleArchive::set_has_tschchartinfobardeprecated3dbeveledges() {
  _has_bits_[1] |= 0x00000008u;
}
inline void ChartStyleArchive::clear_has_tschchartinfobardeprecated3dbeveledges() {
  _has_bits_[1] &= ~0x00000008u;
}
inline void ChartStyleArchive::clear_tschchartinfobardeprecated3dbeveledges() {
  tschchartinfobardeprecated3dbeveledges_ = false;
  clear_has_tschchartinfobardeprecated3dbeveledges();
}
...
inline void ChartStyleArchive::set_has_tschchartinfocolumndeprecated3dbeveledges() {
  _has_bits_[1] |= 0x00000010u;
}
inline void ChartStyleArchive::clear_has_tschchartinfocolumndeprecated3dbeveledges() {
  _has_bits_[1] &= ~0x00000010u;
}
inline void ChartStyleArchive::clear_tschchartinfocolumndeprecated3dbeveledges() {
  ...
  clear_has_tschchartinfocolumndeprecated3dbeveledges();
}
...
inline void ChartStyleArchive::set_has_tschchartinfodefaultdeprecated3dbarshape() {
  _has_bits_[1] |= 0x00000020u;
}
inline void ChartStyleArchive::clear_has_tschchartinfodefaultdeprecated3dbarshape() {
  _has_bits_[1] &= ~0x00000020u;
}
inline void ChartStyleArchive::clear_tschchartinfodefaultdeprecated3dbarshape() {
  tschchartinfodefaultdeprecated3dbarshape_ = 0;
  clear_has_tschchartinfodefaultdeprecated3dbarshape();
}
inline ::google::protobuf::int32 ChartStyleArchive::tschchartinfodefaultdeprecated3dbarshape() const {
  return tschchartinfodefaultdeprecated3dbarshape_;
}
inline void ChartStyleArchive::set_tschchartinfodefaultdeprecated3dbarshape(::google::protobuf::int32 value) {
...
// optional int32 tschchartinfodefaultdeprecatedagainmasterfontnamedsize = 25;
inline bool ChartNonStyleArchive::has_tschchartinfodefaultdeprecatedagainmasterfontnamedsize() const {
  return (_has_bits_[0] & 0x00000020u) != 0;
}
inline void ChartNonStyleArchive::set_has_tschchartinfodefaultdeprecatedagainmasterfontnamedsize() {
  _has_bits_[0] |= 0x00000020u;
}
inline void ChartNonStyleArchive::clear_has_tschchartinfodefaultdeprecatedagainmasterfontnamedsize() {
  _has_bits_[0] &= ~0x00000020u;
}
inline void ChartNonStyleArchive::clear_tschchartinfodefaultdeprecatedagainmasterfontnamedsize() {
  tschchartinfodefaultdeprecatedagainmasterfontnamedsize_ = 0;
  clear_has_tschchartinfodefaultdeprecatedagainmasterfontnamedsize();
}
inline ::google::protobuf::int32 ChartNonStyleArchive::tschchartinfodefaultdeprecatedagainmasterfontnamedsize() const {
  return tschchartinfodefaultdeprecatedagainmasterfontnamedsize_;
}
inline void ChartNonStyleArchive::set_tschchartinfodefaultdeprecatedagainmasterfontnamedsize(::google::protobuf::int32 value) {
...
inline void ChartNonStyleArchive::set_has_tschchartinfodefaultdeprecated3dlightingpackage() {
  _has_bits_[0] |= 0x00004000u;
}
inline void ChartNonStyleArchive::clear_has_tschchartinfodefaultdeprecated3dlightingpackage() {
  _has_bits_[0] &= ~0x00004000u;
}
inline void ChartNonStyleArchive::clear_tschchartinfodefaultdeprecated3dlightingpackage() {
  ...
  clear_has_tschchartinfodefaultdeprecated3dlightingpackage();
}
inline const ::TSCH::Chart3DLightingPackageArchive& ChartNonStyleArchive::tschchartinfodefaultdeprecated3dlightingpackage() const {
  return tschchartinfodefaultdeprecated3dlightingpackage_ != NULL ? *tschchartinfodefaultdeprecated3dlightingpackage_ : *default_instance_->tschchartinfodefaultdeprecated3dlightingpackage_;
}
inline ::TSCH::Chart3DLightingPackageArchive* ChartNonStyleArchive::mutable_tschchartinfodefaultdeprecated3dlightingpackage() {
  set_has_tschchartinfodefaultdeprecated3dlightingpackage();
  if (tschchartinfodefaultdeprecated3dlightingpackage_ == NULL) tschchartinfodefaultdeprecated3dlightingpackage_ = new ::TSCH::Chart3DLightingPackageArchive;
...
inline void ChartNonStyleArchive::set_has_tschchartinfocolumndeprecated3dlightingpackage() {
  _has_bits_[0] |= 0x00008000u;
}
inline void ChartNonStyleArchive::clear_has_tschchartinfocolumndeprecated3dlightingpackage() {
  _has_bits_[0] &= ~0x00008000u;
}
inline void ChartNonStyleArchive::clear_tschchartinfocolumndeprecated3dlightingpackage() {
  ...
  clear_has_tschchartinfocolumndeprecated3dlightingpackage();
}
inline const ::TSCH::Chart3DLightingPackageArchive& ChartNonStyleArchive::tschchartinfocolumndeprecated3dlightingpackage() const {
  return tschchartinfocolumndeprecated3dlightingpackage_ != NULL ? *tschchartinfocolumndeprecated3dlightingpackage_ : *default_instance_->tschchartinfocolumndeprecated3dlightingpackage_;
}
inline ::TSCH::Chart3DLightingPackageArchive* ChartNonStyleArchive::mutable_tschchartinfocolumndeprecated3dlightingpackage() {
  set_has_tschchartinfocolumndeprecated3dlightingpackage();
  if (tschchartinfocolumndeprecated3dlightingpackage_ == NULL) tschchartinfocolumndeprecated3dlightingpackage_ = new ::TSCH::Chart3DLightingPackageArchive;
...
inline void ChartNonStyleArchive::set_has_tschchartinfobardeprecated3dlightingpackage() {
  _has_bits_[0] |= 0x00010000u;
}
inline void ChartNonStyleArchive::clear_has_tschchartinfobardeprecated3dlightingpackage() {
  _has_bits_[0] &= ~0x00010000u;
}
inline void ChartNonStyleArchive::clear_tschchartinfobardeprecated3dlightingpackage() {
  ...
  clear_has_tschchartinfobardeprecated3dlightingpackage();
}
inline const ::TSCH::Chart3DLightingPackageArchive& ChartNonStyleArchive::tschchartinfobardeprecated3dlightingpackage() const {
  return tschchartinfobardeprecated3dlightingpackage_ != NULL ? *tschchartinfobardeprecated3dlightingpackage_ : *default_instance_->tschchartinfobardeprecated3dlightingpackage_;
}
inline ::TSCH::Chart3DLightingPackageArchive* ChartNonStyleArchive::mutable_tschchartinfobardeprecated3dlightingpackage() {
  set_has_tschchartinfobardeprecated3dlightingpackage();
  if (tschchartinfobardeprecated3dlightingpackage_ == NULL) tschchartinfobardeprecated3dlightingpackage_ = new ::TSCH::Chart3DLightingPackageArchive;
...
inline void ChartNonStyleArchive::set_has_tschchartinfolinedeprecated3dlightingpackage() {
  _has_bits_[0] |= 0x00020000u;
}
inline void ChartNonStyleArchive::clear_has_tschchartinfolinedeprecated3dlightingpackage() {
  _has_bits_[0] &= ~0x00020000u;
}
inline void ChartNonStyleArchive::clear_tschchartinfolinedeprecated3dlightingpackage() {
  ...
  clear_has_tschchartinfolinedeprecated3dlightingpackage();
}
inline const ::TSCH::Chart3DLightingPackageArchive& ChartNonStyleArchive::tschchartinfolinedeprecated3dlightingpackage() const {
  return tschchartinfolinedeprecated3dlightingpackage_ != NULL ? *tschchartinfolinedeprecated3dlightingpackage_ : *default_instance_->tschchartinfolinedeprecated3dlightingpackage_;
}
inline ::TSCH::Chart3DLightingPackageArchive* ChartNonStyleArchive::mutable_tschchartinfolinedeprecated3dlightingpackage() {
  set_has_tschchartinfolinedeprecated3dlightingpackage();
  if (tschchartinfolinedeprecated3dlightingpackage_ == NULL) tschchartinfolinedeprecated3dlightingpackage_ = new ::TSCH::Chart3DLightingPackageArchive;
...
inline void ChartNonStyleArchive::set_has_tschchartinfoareadeprecated3dlightingpackage() {
  _has_bits_[0] |= 0x00040000u;
}
inline void ChartNonStyleArchive::clear_has_tschchartinfoareadeprecated3dlightingpackage() {
  _has_bits_[0] &= ~0x00040000u;
}
inline void ChartNonStyleArchive::clear_tschchartinfoareadeprecated3dlightingpackage() {
  ...
  clear_has_tschchartinfoareadeprecated3dlightingpackage();
}
inline const ::TSCH::Chart3DLightingPackageArchive& ChartNonStyleArchive::tschchartinfoareadeprecated3dlightingpackage() const {
  return tschchartinfoareadeprecated3dlightingpackage_ != NULL ? *tschchartinfoareadeprecated3dlightingpackage_ : *default_instance_->tschchartinfoareadeprecated3dlightingpackage_;
}
inline ::TSCH::Chart3DLightingPackageArchive* ChartNonStyleArchive::mutable_tschchartinfoareadeprecated3dlightingpackage() {
  set_has_tschchartinfoareadeprecated3dlightingpackage();
  if (tschchartinfoareadeprecated3dlightingpackage_ == NULL) tschchartinfoareadeprecated3dlightingpackage_ = new ::TSCH::Chart3DLightingPackageArchive;
...
inline void ChartNonStyleArchive::set_has_tschchartinfopiedeprecated3dlightingpackage() {
  _has_bits_[0] |= 0x00080000u;
}
inline void ChartNonStyleArchive::clear_has_tschchartinfopiedeprecated3dlightingpackage() {
  _has_bits_[0] &= ~0x00080000u;
}
inline void ChartNonStyleArchive::clear_tschchartinfopiedeprecated3dlightingpackage() {
  ...
  clear_has_tschchartinfopiedeprecated3dlightingpackage();
}
inline const ::TSCH::Chart3DLightingPackageArchive& ChartNonStyleArchive::tschchartinfopiedeprecated3dlightingpackage() const {
  return tschchartinfopiedeprecated3dlightingpackage_ != NULL ? *tschchartinfopiedeprecated3dlightingpackage_ : *default_instance_->tschchartinfopiedeprecated3dlightingpackage_;
}
inline ::TSCH::Chart3DLightingPackageArchive* ChartNonStyleArchive::mutable_tschchartinfopiedeprecated3dlightingpackage() {
  set_has_tschchartinfopiedeprecated3dlightingpackage();
  if (tschchartinfopiedeprecated3dlightingpackage_ == NULL) tschchartinfopiedeprecated3dlightingpackage_ = new ::TSCH::Chart3DLightingPackageArchive;
...
inline ::TSCH::PreUFF::ChartsNumberFormatArchive* ChartAxisNonStyleArchive::mutable_tschchartaxisdefaultnumberformat() {
  ...
  if (tschchartaxisdefaultnumberformat_ == NULL) tschchartaxisdefaultnumberformat_ = new ::TSCH::PreUFF::ChartsNumberFormatArchive;
...
inline void ChartSeriesStyleArchive::set_has_tschchartseriespiedeprecatedserieslabelson() {
  _has_bits_[0] |= 0x10000000u;
}
inline void ChartSeriesStyleArchive::clear_has_tschchartseriespiedeprecatedserieslabelson() {
  _has_bits_[0] &= ~0x10000000u;
}
inline void ChartSeriesStyleArchive::clear_tschchartseriespiedeprecatedserieslabelson() {
  ...
  clear_has_tschchartseriespiedeprecatedserieslabelson();
}
...
inline void ChartSeriesStyleArchive::set_has_tschchartseriesdefaultdeprecated3dfill() {
  _has_bits_[2] |= 0x40000000u;
}
inline void ChartSeriesStyleArchive::clear_has_tschchartseriesdefaultdeprecated3dfill() {
  _has_bits_[2] &= ~0x40000000u;
}
inline void ChartSeriesStyleArchive::clear_tschchartseriesdefaultdeprecated3dfill() {
  ...
  clear_has_tschchartseriesdefaultdeprecated3dfill();
}
inline const ::TSCH::DEPRECATEDChart3DFillArchive& ChartSeriesStyleArchive::tschchartseriesdefaultdeprecated3dfill() const {
  return tschchartseriesdefaultdeprecated3dfill_ != NULL ? *tschchartseriesdefaultdeprecated3dfill_ : *default_instance_->tschchartseriesdefaultdeprecated3dfill_;
}
inline ::TSCH::DEPRECATEDChart3DFillArchive* ChartSeriesStyleArchive::mutable_tschchartseriesdefaultdeprecated3dfill() {
  set_has_tschchartseriesdefaultdeprecated3dfill();
  if (tschchartseriesdefaultdeprecated3dfill_ == NULL) tschchartseriesdefaultdeprecated3dfill_ = new ::TSCH::DEPRECATEDChart3DFillArchive;
...
inline void ChartSeriesStyleArchive::set_has_tschchartseriesbardeprecated3dfill() {
  _has_bits_[2] |= 0x80000000u;
}
inline void ChartSeriesStyleArchive::clear_has_tschchartseriesbardeprecated3dfill() {
  _has_bits_[2] &= ~0x80000000u;
}
inline void ChartSeriesStyleArchive::clear_tschchartseriesbardeprecated3dfill() {
  if (tschchartseriesbardeprecated3dfill_ != NULL) tschchartseriesbardeprecated3dfill_->::TSCH::DEPRECATEDChart3DFillArchive::Clear();
  clear_has_tschchartseriesbardeprecated3dfill();
}
inline const ::TSCH::DEPRECATEDChart3DFillArchive& ChartSeriesStyleArchive::tschchartseriesbardeprecated3dfill() const {
  return tschchartseriesbardeprecated3dfill_ != NULL ? *tschchartseriesbardeprecated3dfill_ : *default_instance_->tschchartseriesbardeprecated3dfill_;
}
inline ::TSCH::DEPRECATEDChart3DFillArchive* ChartSeriesStyleArchive::mutable_tschchartseriesbardeprecated3dfill() {
  set_has_tschchartseriesbardeprecated3dfill();
  if (tschchartseriesbardeprecated3dfill_ == NULL) tschchartseriesbardeprecated3dfill_ = new ::TSCH::DEPRECATEDChart3DFillArchive;
...
inline void ChartSeriesStyleArchive::set_has_tschchartseriescolumndeprecated3dfill() {
  _has_bits_[3] |= 0x00000001u;
}
inline void ChartSeriesStyleArchive::clear_has_tschchartseriescolumndeprecated3dfill() {
  _has_bits_[3] &= ~0x00000001u;
}
inline void ChartSeriesStyleArchive::clear_tschchartseriescolumndeprecated3dfill() {
  ...
  clear_has_tschchartseriescolumndeprecated3dfill();
}
inline const ::TSCH::DEPRECATEDChart3DFillArchive& ChartSeriesStyleArchive::tschchartseriescolumndeprecated3dfill() const {
  return tschchartseriescolumndeprecated3dfill_ != NULL ? *tschchartseriescolumndeprecated3dfill_ : *default_instance_->tschchartseriescolumndeprecated3dfill_;
}
inline ::TSCH::DEPRECATEDChart3DFillArchive* ChartSeriesStyleArchive::mutable_tschchartseriescolumndeprecated3dfill() {
  set_has_tschchartseriescolumndeprecated3dfill();
  if (tschchartseriescolumndeprecated3dfill_ == NULL) tschchartseriescolumndeprecated3dfill_ = new ::TSCH::DEPRECATEDChart3DFillArchive;
...
inline void ChartSeriesStyleArchive::set_has_tschchartserieslinedeprecated3dfill() {
  _has_bits_[3] |= 0x00000002u;
}
inline void ChartSeriesStyleArchive::clear_has_tschchartserieslinedeprecated3dfill() {
  _has_bits_[3] &= ~0x00000002u;
}
inline void ChartSeriesStyleArchive::clear_tschchartserieslinedeprecated3dfill() {
  ...
  clear_has_tschchartserieslinedeprecated3dfill();
}
inline const ::TSCH::DEPRECATEDChart3DFillArchive& ChartSeriesStyleArchive::tschchartserieslinedeprecated3dfill() const {
  return tschchartserieslinedeprecated3dfill_ != NULL ? *tschchartserieslinedeprecated3dfill_ : *default_instance_->tschchartserieslinedeprecated3dfill_;
}
inline ::TSCH::DEPRECATEDChart3DFillArchive* ChartSeriesStyleArchive::mutable_tschchartserieslinedeprecated3dfill() {
  set_has_tschchartserieslinedeprecated3dfill();
  if (tschchartserieslinedeprecated3dfill_ == NULL) tschchartserieslinedeprecated3dfill_ = new ::TSCH::DEPRECATEDChart3DFillArchive;
...
inline void ChartSeriesStyleArchive::set_has_tschchartseriesareadeprecated3dfill() {
  _has_bits_[3] |= 0x00000004u;
}
inline void ChartSeriesStyleArchive::clear_has_tschchartseriesareadeprecated3dfill() {
  _has_bits_[3] &= ~0x00000004u;
}
inline void ChartSeriesStyleArchive::clear_tschchartseriesareadeprecated3dfill() {
  ...
  clear_has_tschchartseriesareadeprecated3dfill();
}
inline const ::TSCH::DEPRECATEDChart3DFillArchive& ChartSeriesStyleArchive::tschchartseriesareadeprecated3dfill() const {
  return tschchartseriesareadeprecated3dfill_ != NULL ? *tschchartseriesareadeprecated3dfill_ : *default_instance_->tschchartseriesareadeprecated3dfill_;
}
inline ::TSCH::DEPRECATEDChart3DFillArchive* ChartSeriesStyleArchive::mutable_tschchartseriesareadeprecated3dfill() {
  set_has_tschchartseriesareadeprecated3dfill();
  if (tschchartseriesareadeprecated3dfill_ == NULL) tschchartseriesareadeprecated3dfill_ = new ::TSCH::DEPRECATEDChart3DFillArchive;
...
inline void ChartSeriesStyleArchive::set_has_tschchartseriespiedeprecated3dfill() {
  _has_bits_[3] |= 0x00000008u;
}
inline void ChartSeriesStyleArchive::clear_has_tschchartseriespiedeprecated3dfill() {
  _has_bits_[3] &= ~0x00000008u;
}
inline void ChartSeriesStyleArchive::clear_tschchartseriespiedeprecated3dfill() {
  if (tschchartseriespiedeprecated3dfill_ != NULL) tschchartseriespiedeprecated3dfill_->::TSCH::DEPRECATEDChart3DFillArchive::Clear();
  clear_has_tschchartseriespiedeprecated3dfill();
}
inline const ::TSCH::DEPRECATEDChart3DFillArchive& ChartSeriesStyleArchive::tschchartseriespiedeprecated3dfill() const {
  return tschchartseriespiedeprecated3dfill_ != NULL ? *tschchartseriespiedeprecated3dfill_ : *default_instance_->tschchartseriespiedeprecated3dfill_;
}
inline ::TSCH::DEPRECATEDChart3DFillArchive* ChartSeriesStyleArchive::mutable_tschchartseriespiedeprecated3dfill() {
  set_has_tschchartseriespiedeprecated3dfill();
  if (tschchartseriespiedeprecated3dfill_ == NULL) tschchartseriespiedeprecated3dfill_ = new ::TSCH::DEPRECATEDChart3DFillArchive;
...
inline ::TSCH::PreUFF::ChartsNumberFormatArchive* ChartSeriesNonStyleArchive::mutable_tschchartseriesdefaultnumberformat() {
  ...
  if (tschchartseriesdefaultnumberformat_ == NULL) tschchartseriesdefaultnumberformat_ = new ::TSCH::PreUFF::ChartsNumberFormatArchive;
...
inline ::TSCH::PreUFF::ChartsNumberFormatArchive* ChartSeriesNonStyleArchive::mutable_tschchartseriespienumberformat() {
  ...
  if (tschchartseriespienumberformat_ == NULL) tschchartseriespienumberformat_ = new ::TSCH::PreUFF::ChartsNumberFormatArchive;
...
inline ::TSCH::PreUFF::ChartsNumberFormatArchive* ChartSeriesNonStyleArchive::mutable_tschchartseriesstackedpercentnumberformat() {
  ...
  if (tschchartseriesstackedpercentnumberformat_ == NULL) tschchartseriesstackedpercentnumberformat_ = new ::TSCH::PreUFF::ChartsNumberFormatArchive;
...
#endif  // PROTOBUF_TSCHPreUFFArchives_2eproto__INCLUDED
